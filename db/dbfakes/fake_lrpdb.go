...
type FakeLRPDB struct {
	...
	SuspectActualLRPStub        func(logger lager.Logger, key *models.ActualLRPKey) (before *models.ActualLRPGroup, after *models.ActualLRPGroup, err error)
	suspectActualLRPMutex       sync.RWMutex
	suspectActualLRPArgsForCall []struct {
		logger lager.Logger
		key    *models.ActualLRPKey
	}
	suspectActualLRPReturns struct {
		result1 *models.ActualLRPGroup
		result2 *models.ActualLRPGroup
		result3 error
	}
	suspectActualLRPReturnsOnCall map[int]struct {
		result1 *models.ActualLRPGroup
		result2 *models.ActualLRPGroup
		result3 error
	}
...
func (fake *FakeLRPDB) SuspectActualLRP(logger lager.Logger, key *models.ActualLRPKey) (before *models.ActualLRPGroup, after *models.ActualLRPGroup, err error) {
	fake.suspectActualLRPMutex.Lock()
	ret, specificReturn := fake.suspectActualLRPReturnsOnCall[len(fake.suspectActualLRPArgsForCall)]
	fake.suspectActualLRPArgsForCall = append(fake.suspectActualLRPArgsForCall, struct {
		logger lager.Logger
		key    *models.ActualLRPKey
	}{logger, key})
	fake.recordInvocation("SuspectActualLRP", []interface{}{logger, key})
	fake.suspectActualLRPMutex.Unlock()
	if fake.SuspectActualLRPStub != nil {
		return fake.SuspectActualLRPStub(logger, key)
	}
	if specificReturn {
		return ret.result1, ret.result2, ret.result3
	}
	return fake.suspectActualLRPReturns.result1, fake.suspectActualLRPReturns.result2, fake.suspectActualLRPReturns.result3
}

func (fake *FakeLRPDB) SuspectActualLRPCallCount() int {
	fake.suspectActualLRPMutex.RLock()
	defer fake.suspectActualLRPMutex.RUnlock()
	return len(fake.suspectActualLRPArgsForCall)
}

func (fake *FakeLRPDB) SuspectActualLRPArgsForCall(i int) (lager.Logger, *models.ActualLRPKey) {
	fake.suspectActualLRPMutex.RLock()
	defer fake.suspectActualLRPMutex.RUnlock()
	return fake.suspectActualLRPArgsForCall[i].logger, fake.suspectActualLRPArgsForCall[i].key
}

func (fake *FakeLRPDB) SuspectActualLRPReturns(result1 *models.ActualLRPGroup, result2 *models.ActualLRPGroup, result3 error) {
	fake.SuspectActualLRPStub = nil
	fake.suspectActualLRPReturns = struct {
		result1 *models.ActualLRPGroup
		result2 *models.ActualLRPGroup
		result3 error
	}{result1, result2, result3}
...
func (fake *FakeLRPDB) SuspectActualLRPReturnsOnCall(i int, result1 *models.ActualLRPGroup, result2 *models.ActualLRPGroup, result3 error) {
	fake.SuspectActualLRPStub = nil
	if fake.suspectActualLRPReturnsOnCall == nil {
		fake.suspectActualLRPReturnsOnCall = make(map[int]struct {
			result1 *models.ActualLRPGroup
			result2 *models.ActualLRPGroup
			result3 error
		})
	}
	fake.suspectActualLRPReturnsOnCall[i] = struct {
		result1 *models.ActualLRPGroup
		result2 *models.ActualLRPGroup
		result3 error
	}{result1, result2, result3}
...
func (fake *FakeLRPDB) CreateRunningActualLRP(logger lager.Logger, key *models.ActualLRPKey, instanceKey *models.ActualLRPInstanceKey, netInfo *models.ActualLRPNetInfo) error {
...
func (fake *FakeLRPDB) CreateRunningActualLRPCallCount() int {
...
func (fake *FakeLRPDB) CreateRunningActualLRPArgsForCall(i int) (lager.Logger, *models.ActualLRPKey, *models.ActualLRPInstanceKey, *models.ActualLRPNetInfo) {
	fake.createRunningActualLRPMutex.RLock()
	defer fake.createRunningActualLRPMutex.RUnlock()
...
func (fake *FakeLRPDB) CreateRunningActualLRPReturns(result1 error) {
...
func (fake *FakeLRPDB) CreateRunningActualLRPReturnsOnCall(i int, result1 error) {
	fake.CreateRunningActualLRPStub = nil
