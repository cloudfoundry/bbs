...
func (fake *FakeLRPDB) CreateLRPDeployment(logger lager.Logger, lrp *models.LRPDeploymentCreation) (string, error) {
...
func (fake *FakeLRPDB) CreateLRPDeploymentReturns(result1 string, result2 error) {
...
func (fake *FakeLRPDB) CreateLRPDeploymentReturnsOnCall(i int, result1 string, result2 error) {
	fake.CreateLRPDeploymentStub = nil
...
func (fake *FakeLRPDB) UpdateLRPDeployment(logger lager.Logger, id string, definition *models.LRPDeploymentUpdate) (string, error) {
...
func (fake *FakeLRPDB) UpdateLRPDeploymentReturns(result1 string, result2 error) {
...
func (fake *FakeLRPDB) UpdateLRPDeploymentReturnsOnCall(i int, result1 string, result2 error) {
	fake.UpdateLRPDeploymentStub = nil
...
func (fake *FakeLRPDB) SaveLRPDeployment(logger lager.Logger, lrpDeployment *models.LRPDeployment) error {
...
func (fake *FakeLRPDB) SaveLRPDeploymentReturns(result1 error) {
...
func (fake *FakeLRPDB) SaveLRPDeploymentReturnsOnCall(i int, result1 error) {
	fake.SaveLRPDeploymentStub = nil
...
func (fake *FakeLRPDB) DeleteLRPDeployment(logger lager.Logger, id string) error {
...
func (fake *FakeLRPDB) DeleteLRPDeploymentReturns(result1 error) {
...
func (fake *FakeLRPDB) DeleteLRPDeploymentReturnsOnCall(i int, result1 error) {
	fake.DeleteLRPDeploymentStub = nil
...
func (fake *FakeLRPDB) ActivateLRPDeploymentDefinition(logger lager.Logger, id string, definitionID string) error {
...
func (fake *FakeLRPDB) ActivateLRPDeploymentDefinitionReturns(result1 error) {
...
func (fake *FakeLRPDB) ActivateLRPDeploymentDefinitionReturnsOnCall(i int, result1 error) {
	fake.ActivateLRPDeploymentDefinitionStub = nil
