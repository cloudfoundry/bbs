...
type FakeLRPDB struct {
	...
	ActualLRPsByProcessGuidsStub        func(context.Context, lager.Logger, models.ActualLRPsByProcessGuidsFilter) ([]*models.ActualLRP, error)
	...
	StartActualLRPStub        func(context.Context, lager.Logger, *models.ActualLRPKey, *models.ActualLRPInstanceKey, *models.ActualLRPNetInfo, []*models.ActualLRPInternalRoute, map[string]string, bool, string, bool) (*models.ActualLRP, *models.ActualLRP, error)
	...
	UnclaimActualLRPStub        func(context.Context, lager.Logger, bool, *models.ActualLRPKey) (*models.ActualLRP, *models.ActualLRP, error)
...
func (fake *FakeLRPDB) ActualLRPsByProcessGuids(arg1 context.Context, arg2 lager.Logger, arg3 models.ActualLRPsByProcessGuidsFilter) ([]*models.ActualLRP, error) {
...
func (fake *FakeLRPDB) ActualLRPsByProcessGuidsCallCount() int {
...
func (fake *FakeLRPDB) ActualLRPsByProcessGuidsCalls(stub func(context.Context, lager.Logger, models.ActualLRPsByProcessGuidsFilter) ([]*models.ActualLRP, error)) {
	fake.actualLRPsByProcessGuidsMutex.Lock()
	defer fake.actualLRPsByProcessGuidsMutex.Unlock()
	fake.ActualLRPsByProcessGuidsStub = stub
}

func (fake *FakeLRPDB) ActualLRPsByProcessGuidsArgsForCall(i int) (context.Context, lager.Logger, models.ActualLRPsByProcessGuidsFilter) {
	fake.actualLRPsByProcessGuidsMutex.RLock()
	defer fake.actualLRPsByProcessGuidsMutex.RUnlock()
...
func (fake *FakeLRPDB) ActualLRPsByProcessGuidsReturns(result1 []*models.ActualLRP, result2 error) {
	fake.actualLRPsByProcessGuidsMutex.Lock()
	defer fake.actualLRPsByProcessGuidsMutex.Unlock()
...
func (fake *FakeLRPDB) ActualLRPsByProcessGuidsReturnsOnCall(i int, result1 []*models.ActualLRP, result2 error) {
	fake.actualLRPsByProcessGuidsMutex.Lock()
	defer fake.actualLRPsByProcessGuidsMutex.Unlock()
	fake.ActualLRPsByProcessGuidsStub = nil
...
func (fake *FakeLRPDB) ChangeActualLRPPresence(arg1 context.Context, arg2 lager.Logger, arg3 *models.ActualLRPKey, arg4 models.ActualLRP_Presence, arg5 models.ActualLRP_Presence) (*models.ActualLRP, *models.ActualLRP, error) {
	...
	stub := fake.ChangeActualLRPPresenceStub
...
func (fake *FakeLRPDB) CountActualLRPsByState(arg1 context.Context, arg2 lager.Logger) (int, int, int, int, int) {
	...
	stub := fake.CountActualLRPsByStateStub
...
func (fake *FakeLRPDB) CountDesiredInstances(arg1 context.Context, arg2 lager.Logger) int {
	...
	stub := fake.CountDesiredInstancesStub
...
func (fake *FakeLRPDB) CreateUnclaimedActualLRP(arg1 context.Context, arg2 lager.Logger, arg3 *models.ActualLRPKey) (*models.ActualLRP, error) {
	...
	stub := fake.CreateUnclaimedActualLRPStub
...
func (fake *FakeLRPDB) DesiredLRPUpdateStrategyByProcessGuid(arg1 context.Context, arg2 lager.Logger, arg3 string) (models.DesiredLRP_UpdateStrategy, int32, error) {
	...
	stub := fake.DesiredLRPUpdateStrategyByProcessGuidStub
	fakeReturns := fake.desiredLRPUpdateStrategyByProcessGuidReturns
	fake.recordInvocation("DesiredLRPUpdateStrategyByProcessGuid", []interface{}{arg1, arg2, arg3})
	fake.desiredLRPUpdateStrategyByProcessGuidMutex.Unlock()
	if stub != nil {
		return stub(arg1, arg2, arg3)
	}
	if specificReturn {
...
func (fake *FakeLRPDB) DesiredLRPUpdateStrategyByProcessGuidCallCount() int {
	fake.desiredLRPUpdateStrategyByProcessGuidMutex.RLock()
	defer fake.desiredLRPUpdateStrategyByProcessGuidMutex.RUnlock()
	return len(fake.desiredLRPUpdateStrategyByProcessGuidArgsForCall)
}

func (fake *FakeLRPDB) DesiredLRPUpdateStrategyByProcessGuidCalls(stub func(context.Context, lager.Logger, string) (models.DesiredLRP_UpdateStrategy, int32, error)) {
	fake.desiredLRPUpdateStrategyByProcessGuidMutex.Lock()
	defer fake.desiredLRPUpdateStrategyByProcessGuidMutex.Unlock()
	fake.DesiredLRPUpdateStrategyByProcessGuidStub = stub
}

func (fake *FakeLRPDB) DesiredLRPUpdateStrategyByProcessGuidArgsForCall(i int) (context.Context, lager.Logger, string) {
	fake.desiredLRPUpdateStrategyByProcessGuidMutex.RLock()
	defer fake.desiredLRPUpdateStrategyByProcessGuidMutex.RUnlock()
	argsForCall := fake.desiredLRPUpdateStrategyByProcessGuidArgsForCall[i]
	return argsForCall.arg1, argsForCall.arg2, argsForCall.arg3
}

func (fake *FakeLRPDB) DesiredLRPUpdateStrategyByProcessGuidReturns(result1 models.DesiredLRP_UpdateStrategy, result2 int32, result3 error) {
	fake.desiredLRPUpdateStrategyByProcessGuidMutex.Lock()
	defer fake.desiredLRPUpdateStrategyByProcessGuidMutex.Unlock()
...
func (fake *FakeLRPDB) DesiredLRPUpdateStrategyByProcessGuidReturnsOnCall(i int, result1 models.DesiredLRP_UpdateStrategy, result2 int32, result3 error) {
	fake.desiredLRPUpdateStrategyByProcessGuidMutex.Lock()
	defer fake.desiredLRPUpdateStrategyByProcessGuidMutex.Unlock()
	fake.DesiredLRPUpdateStrategyByProcessGuidStub = nil
...
func (fake *FakeLRPDB) StartActualLRP(arg1 context.Context, arg2 lager.Logger, arg3 *models.ActualLRPKey, arg4 *models.ActualLRPInstanceKey, arg5 *models.ActualLRPNetInfo, arg6 []*models.ActualLRPInternalRoute, arg7 map[string]string, arg8 bool, arg9 string, arg10 bool) (*models.ActualLRP, *models.ActualLRP, error) {
	...
	fake.startActualLRPArgsForCall = append(fake.startActualLRPArgsForCall, struct {
		...
		arg9  string
		arg10 bool
	}{arg1, arg2, arg3, arg4, arg5, arg6Copy, arg7, arg8, arg9, arg10})
	stub := fake.StartActualLRPStub
	fakeReturns := fake.startActualLRPReturns
	fake.recordInvocation("StartActualLRP", []interface{}{arg1, arg2, arg3, arg4, arg5, arg6Copy, arg7, arg8, arg9, arg10})
...
func (fake *FakeLRPDB) StartActualLRPCalls(stub func(context.Context, lager.Logger, *models.ActualLRPKey, *models.ActualLRPInstanceKey, *models.ActualLRPNetInfo, []*models.ActualLRPInternalRoute, map[string]string, bool, string, bool) (*models.ActualLRP, *models.ActualLRP, error)) {
	fake.startActualLRPMutex.Lock()
	defer fake.startActualLRPMutex.Unlock()
	fake.StartActualLRPStub = stub
}

func (fake *FakeLRPDB) StartActualLRPArgsForCall(i int) (context.Context, lager.Logger, *models.ActualLRPKey, *models.ActualLRPInstanceKey, *models.ActualLRPNetInfo, []*models.ActualLRPInternalRoute, map[string]string, bool, string, bool) {
	fake.startActualLRPMutex.RLock()
	defer fake.startActualLRPMutex.RUnlock()
...
func (fake *FakeLRPDB) UnclaimActualLRP(arg1 context.Context, arg2 lager.Logger, arg3 bool, arg4 *models.ActualLRPKey) (*models.ActualLRP, *models.ActualLRP, error) {
	...
	stub := fake.UnclaimActualLRPStub
	fakeReturns := fake.unclaimActualLRPReturns
	fake.recordInvocation("UnclaimActualLRP", []interface{}{arg1, arg2, arg3, arg4})
...
func (fake *FakeLRPDB) UnclaimActualLRPCalls(stub func(context.Context, lager.Logger, bool, *models.ActualLRPKey) (*models.ActualLRP, *models.ActualLRP, error)) {
	fake.unclaimActualLRPMutex.Lock()
	defer fake.unclaimActualLRPMutex.Unlock()
	fake.UnclaimActualLRPStub = stub
}

func (fake *FakeLRPDB) UnclaimActualLRPArgsForCall(i int) (context.Context, lager.Logger, bool, *models.ActualLRPKey) {
	fake.unclaimActualLRPMutex.RLock()
	defer fake.unclaimActualLRPMutex.RUnlock()
...
func (fake *FakeLRPDB) UnclaimActualLRPIfAllRunning(arg1 context.Context, arg2 lager.Logger, arg3 bool, arg4 *models.ActualLRPKey, arg5 int32) (*models.ActualLRP, *models.ActualLRP, error) {
...
func (fake *FakeLRPDB) UnclaimActualLRPIfAllRunningCallCount() int {
...
func (fake *FakeLRPDB) UnclaimActualLRPIfAllRunningCalls(stub func(context.Context, lager.Logger, bool, *models.ActualLRPKey, int32) (*models.ActualLRP, *models.ActualLRP, error)) {
	fake.unclaimActualLRPIfAllRunningMutex.Lock()
	defer fake.unclaimActualLRPIfAllRunningMutex.Unlock()
	fake.UnclaimActualLRPIfAllRunningStub = stub
}

func (fake *FakeLRPDB) UnclaimActualLRPIfAllRunningArgsForCall(i int) (context.Context, lager.Logger, bool, *models.ActualLRPKey, int32) {
	fake.unclaimActualLRPIfAllRunningMutex.RLock()
	defer fake.unclaimActualLRPIfAllRunningMutex.RUnlock()
...
func (fake *FakeLRPDB) UnclaimActualLRPIfAllRunningReturns(result1 *models.ActualLRP, result2 *models.ActualLRP, result3 error) {
	fake.unclaimActualLRPIfAllRunningMutex.Lock()
	defer fake.unclaimActualLRPIfAllRunningMutex.Unlock()
...
func (fake *FakeLRPDB) UnclaimActualLRPIfAllRunningReturnsOnCall(i int, result1 *models.ActualLRP, result2 *models.ActualLRP, result3 error) {
	fake.unclaimActualLRPIfAllRunningMutex.Lock()
	defer fake.unclaimActualLRPIfAllRunningMutex.Unlock()
	fake.UnclaimActualLRPIfAllRunningStub = nil
