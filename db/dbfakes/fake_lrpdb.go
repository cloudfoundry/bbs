...
type FakeLRPDB struct {
	...
	CreateUnclaimedActualLRPStub        func(logger lager.Logger, key *models.ActualLRPKey, lrpDeploymentGUID string) (after *models.ActualLRPGroup, err error)
	createUnclaimedActualLRPMutex       sync.RWMutex
	createUnclaimedActualLRPArgsForCall []struct {
		logger            lager.Logger
		key               *models.ActualLRPKey
		lrpDeploymentGUID string
	}
	...
	SaveLRPDeploymentStub        func(logger lager.Logger, lrpDeployment *models.LRPDeployment) (*models.LRPDeployment, error)
...
func (fake *FakeLRPDB) CreateUnclaimedActualLRP(logger lager.Logger, key *models.ActualLRPKey, lrpDeploymentGUID string) (after *models.ActualLRPGroup, err error) {
	...
	fake.createUnclaimedActualLRPArgsForCall = append(fake.createUnclaimedActualLRPArgsForCall, struct {
		...
		key               *models.ActualLRPKey
		lrpDeploymentGUID string
	}{logger, key, lrpDeploymentGUID})
	fake.recordInvocation("CreateUnclaimedActualLRP", []interface{}{logger, key, lrpDeploymentGUID})
	fake.createUnclaimedActualLRPMutex.Unlock()
	if fake.CreateUnclaimedActualLRPStub != nil {
		return fake.CreateUnclaimedActualLRPStub(logger, key, lrpDeploymentGUID)
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
...
func (fake *FakeLRPDB) CreateUnclaimedActualLRPArgsForCall(i int) (lager.Logger, *models.ActualLRPKey, string) {
	fake.createUnclaimedActualLRPMutex.RLock()
	defer fake.createUnclaimedActualLRPMutex.RUnlock()
	return fake.createUnclaimedActualLRPArgsForCall[i].logger, fake.createUnclaimedActualLRPArgsForCall[i].key, fake.createUnclaimedActualLRPArgsForCall[i].lrpDeploymentGUID
}
...
func (fake *FakeLRPDB) DesireLRP(logger lager.Logger, desiredLRP *models.DesiredLRP) (string, error) {
...
func (fake *FakeLRPDB) DesireLRPReturns(result1 string, result2 error) {
...
func (fake *FakeLRPDB) DesireLRPReturnsOnCall(i int, result1 string, result2 error) {
	fake.DesireLRPStub = nil
...
func (fake *FakeLRPDB) CreateLRPDeployment(logger lager.Logger, lrp *models.LRPDeploymentCreation) (*models.LRPDeployment, error) {
...
func (fake *FakeLRPDB) CreateLRPDeploymentArgsForCall(i int) (lager.Logger, *models.LRPDeploymentCreation) {
	fake.createLRPDeploymentMutex.RLock()
	defer fake.createLRPDeploymentMutex.RUnlock()
...
func (fake *FakeLRPDB) UpdateLRPDeploymentCallCount() int {
...
func (fake *FakeLRPDB) UpdateLRPDeploymentArgsForCall(i int) (lager.Logger, string, *models.LRPDeploymentUpdate) {
	fake.updateLRPDeploymentMutex.RLock()
	defer fake.updateLRPDeploymentMutex.RUnlock()
...
func (fake *FakeLRPDB) SaveLRPDeployment(logger lager.Logger, lrpDeployment *models.LRPDeployment) (*models.LRPDeployment, error) {
...
func (fake *FakeLRPDB) SaveLRPDeploymentCallCount() int {
	fake.saveLRPDeploymentMutex.RLock()
	defer fake.saveLRPDeploymentMutex.RUnlock()
	return len(fake.saveLRPDeploymentArgsForCall)
}

func (fake *FakeLRPDB) SaveLRPDeploymentArgsForCall(i int) (lager.Logger, *models.LRPDeployment) {
	fake.saveLRPDeploymentMutex.RLock()
	defer fake.saveLRPDeploymentMutex.RUnlock()
	return fake.saveLRPDeploymentArgsForCall[i].logger, fake.saveLRPDeploymentArgsForCall[i].lrpDeployment
}

func (fake *FakeLRPDB) SaveLRPDeploymentReturns(result1 *models.LRPDeployment, result2 error) {
...
func (fake *FakeLRPDB) SaveLRPDeploymentReturnsOnCall(i int, result1 *models.LRPDeployment, result2 error) {
	fake.SaveLRPDeploymentStub = nil
...
func (fake *FakeLRPDB) DeleteLRPDeployment(logger lager.Logger, id string) (*models.LRPDeployment, error) {
...
func (fake *FakeLRPDB) DeleteLRPDeploymentCallCount() int {
...
func (fake *FakeLRPDB) DeleteLRPDeploymentArgsForCall(i int) (lager.Logger, string) {
	fake.deleteLRPDeploymentMutex.RLock()
	defer fake.deleteLRPDeploymentMutex.RUnlock()
	return fake.deleteLRPDeploymentArgsForCall[i].logger, fake.deleteLRPDeploymentArgsForCall[i].id
}

func (fake *FakeLRPDB) DeleteLRPDeploymentReturns(result1 *models.LRPDeployment, result2 error) {
...
func (fake *FakeLRPDB) DeleteLRPDeploymentReturnsOnCall(i int, result1 *models.LRPDeployment, result2 error) {
	fake.DeleteLRPDeploymentStub = nil
...
func (fake *FakeLRPDB) ActivateLRPDeploymentDefinition(logger lager.Logger, id string, definitionID string) (*models.LRPDeployment, error) {
...
func (fake *FakeLRPDB) ActivateLRPDeploymentDefinitionCallCount() int {
...
func (fake *FakeLRPDB) ActivateLRPDeploymentDefinitionArgsForCall(i int) (lager.Logger, string, string) {
	fake.activateLRPDeploymentDefinitionMutex.RLock()
	defer fake.activateLRPDeploymentDefinitionMutex.RUnlock()
...
func (fake *FakeLRPDB) ActivateLRPDeploymentDefinitionReturns(result1 *models.LRPDeployment, result2 error) {
...
func (fake *FakeLRPDB) ActivateLRPDeploymentDefinitionReturnsOnCall(i int, result1 *models.LRPDeployment, result2 error) {
	fake.ActivateLRPDeploymentDefinitionStub = nil
...
func (fake *FakeLRPDB) LRPDeploymentByDefinitionGuid(logger lager.Logger, id string) (*models.LRPDeployment, error) {
...
func (fake *FakeLRPDB) LRPDeploymentByDefinitionGuidCallCount() int {
...
func (fake *FakeLRPDB) LRPDeploymentByDefinitionGuidArgsForCall(i int) (lager.Logger, string) {
	fake.lRPDeploymentByDefinitionGuidMutex.RLock()
	defer fake.lRPDeploymentByDefinitionGuidMutex.RUnlock()
	return fake.lRPDeploymentByDefinitionGuidArgsForCall[i].logger, fake.lRPDeploymentByDefinitionGuidArgsForCall[i].id
}

func (fake *FakeLRPDB) LRPDeploymentByDefinitionGuidReturns(result1 *models.LRPDeployment, result2 error) {
...
func (fake *FakeLRPDB) LRPDeploymentByDefinitionGuidReturnsOnCall(i int, result1 *models.LRPDeployment, result2 error) {
	fake.LRPDeploymentByDefinitionGuidStub = nil
...
func (fake *FakeLRPDB) ConvergeLRPsReturnsOnCall(i int, result1 []*auctioneer.LRPStartRequest, result2 []*models.ActualLRPKeyWithSchedulingInfo, result3 []*models.ActualLRPKey) {
	fake.ConvergeLRPsStub = nil
