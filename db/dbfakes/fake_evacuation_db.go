...
func (fake *FakeEvacuationDB) EvacuateActualLRP(arg1 lager.Logger, arg2 *models.ActualLRPKey, arg3 *models.ActualLRPInstanceKey, arg4 *models.ActualLRPNetInfo, arg5 uint64) (*models.FlattenedActualLRP, error) {
...
func (fake *FakeEvacuationDB) EvacuateActualLRPReturns(result1 *models.FlattenedActualLRP, result2 error) {
...
func (fake *FakeEvacuationDB) EvacuateActualLRPReturnsOnCall(i int, result1 *models.FlattenedActualLRP, result2 error) {
	fake.EvacuateActualLRPStub = nil
