...
func (fake *FakeActualLRPDB) SuspectActualLRP(logger lager.Logger, key *models.ActualLRPKey) (before *models.ActualLRPGroup, after *models.ActualLRPGroup, err error) {
...
func (fake *FakeActualLRPDB) SuspectActualLRPCallCount() int {
	fake.suspectActualLRPMutex.RLock()
	defer fake.suspectActualLRPMutex.RUnlock()
	return len(fake.suspectActualLRPArgsForCall)
}

func (fake *FakeActualLRPDB) SuspectActualLRPArgsForCall(i int) (lager.Logger, *models.ActualLRPKey) {
	fake.suspectActualLRPMutex.RLock()
	defer fake.suspectActualLRPMutex.RUnlock()
	return fake.suspectActualLRPArgsForCall[i].logger, fake.suspectActualLRPArgsForCall[i].key
}

func (fake *FakeActualLRPDB) SuspectActualLRPReturns(result1 *models.ActualLRPGroup, result2 *models.ActualLRPGroup, result3 error) {
...
func (fake *FakeActualLRPDB) SuspectActualLRPReturnsOnCall(i int, result1 *models.ActualLRPGroup, result2 *models.ActualLRPGroup, result3 error) {
	fake.SuspectActualLRPStub = nil
...
func (fake *FakeActualLRPDB) CreateRunningActualLRP(logger lager.Logger, key *models.ActualLRPKey, instanceKey *models.ActualLRPInstanceKey, netInfo *models.ActualLRPNetInfo) error {
...
func (fake *FakeActualLRPDB) CreateRunningActualLRPCallCount() int {
...
func (fake *FakeActualLRPDB) CreateRunningActualLRPArgsForCall(i int) (lager.Logger, *models.ActualLRPKey, *models.ActualLRPInstanceKey, *models.ActualLRPNetInfo) {
	fake.createRunningActualLRPMutex.RLock()
	defer fake.createRunningActualLRPMutex.RUnlock()
...
func (fake *FakeActualLRPDB) CreateRunningActualLRPReturns(result1 error) {
...
func (fake *FakeActualLRPDB) CreateRunningActualLRPReturnsOnCall(i int, result1 error) {
	fake.CreateRunningActualLRPStub = nil
