...
func (fake *FakeDB) ActualLRPsByProcessGuids(arg1 context.Context, arg2 lager.Logger, arg3 models.ActualLRPsByProcessGuidsFilter) ([]*models.ActualLRP, error) {
...
func (fake *FakeDB) ActualLRPsByProcessGuidsCallCount() int {
...
func (fake *FakeDB) ActualLRPsByProcessGuidsCalls(stub func(context.Context, lager.Logger, models.ActualLRPsByProcessGuidsFilter) ([]*models.ActualLRP, error)) {
	fake.actualLRPsByProcessGuidsMutex.Lock()
	defer fake.actualLRPsByProcessGuidsMutex.Unlock()
	fake.ActualLRPsByProcessGuidsStub = stub
}

func (fake *FakeDB) ActualLRPsByProcessGuidsArgsForCall(i int) (context.Context, lager.Logger, models.ActualLRPsByProcessGuidsFilter) {
	fake.actualLRPsByProcessGuidsMutex.RLock()
	defer fake.actualLRPsByProcessGuidsMutex.RUnlock()
...
func (fake *FakeDB) ActualLRPsByProcessGuidsReturns(result1 []*models.ActualLRP, result2 error) {
	fake.actualLRPsByProcessGuidsMutex.Lock()
	defer fake.actualLRPsByProcessGuidsMutex.Unlock()
...
func (fake *FakeDB) ActualLRPsByProcessGuidsReturnsOnCall(i int, result1 []*models.ActualLRP, result2 error) {
	fake.actualLRPsByProcessGuidsMutex.Lock()
	defer fake.actualLRPsByProcessGuidsMutex.Unlock()
	fake.ActualLRPsByProcessGuidsStub = nil
...
func (fake *FakeDB) CountActualLRPsForProcessGuidAndState(arg1 context.Context, arg2 lager.Logger, arg3 string, arg4 string, arg5 models.ActualLRP_Presence) (int, error) {
...
func (fake *FakeDB) CountActualLRPsForProcessGuidAndStateCallCount() int {
...
func (fake *FakeDB) CountActualLRPsForProcessGuidAndStateCalls(stub func(context.Context, lager.Logger, string, string, models.ActualLRP_Presence) (int, error)) {
	fake.countActualLRPsForProcessGuidAndStateMutex.Lock()
	defer fake.countActualLRPsForProcessGuidAndStateMutex.Unlock()
	fake.CountActualLRPsForProcessGuidAndStateStub = stub
}

func (fake *FakeDB) CountActualLRPsForProcessGuidAndStateArgsForCall(i int) (context.Context, lager.Logger, string, string, models.ActualLRP_Presence) {
	fake.countActualLRPsForProcessGuidAndStateMutex.RLock()
	defer fake.countActualLRPsForProcessGuidAndStateMutex.RUnlock()
...
func (fake *FakeDB) CountActualLRPsForProcessGuidAndStateReturns(result1 int, result2 error) {
	fake.countActualLRPsForProcessGuidAndStateMutex.Lock()
	defer fake.countActualLRPsForProcessGuidAndStateMutex.Unlock()
...
func (fake *FakeDB) CountActualLRPsForProcessGuidAndStateReturnsOnCall(i int, result1 int, result2 error) {
	fake.countActualLRPsForProcessGuidAndStateMutex.Lock()
	defer fake.countActualLRPsForProcessGuidAndStateMutex.Unlock()
	fake.CountActualLRPsForProcessGuidAndStateStub = nil
...
func (fake *FakeDB) DesiredLRPUpdateStrategyByProcessGuidArgsForCall(i int) (context.Context, lager.Logger, string) {
	fake.desiredLRPUpdateStrategyByProcessGuidMutex.RLock()
	defer fake.desiredLRPUpdateStrategyByProcessGuidMutex.RUnlock()
...
func (fake *FakeDB) EvacuateActualLRP(arg1 context.Context, arg2 lager.Logger, arg3 *models.ActualLRPKey, arg4 *models.ActualLRPInstanceKey, arg5 *models.ActualLRPNetInfo, arg6 []*models.ActualLRPInternalRoute, arg7 map[string]string, arg8 bool, arg9 string) (*models.ActualLRP, error) {
	...
	fake.recordInvocation("EvacuateActualLRP", []interface{}{arg1, arg2, arg3, arg4, arg5, arg6Copy, arg7, arg8, arg9})
...
func (fake *FakeDB) StartActualLRP(arg1 context.Context, arg2 lager.Logger, arg3 *models.ActualLRPKey, arg4 *models.ActualLRPInstanceKey, arg5 *models.ActualLRPNetInfo, arg6 []*models.ActualLRPInternalRoute, arg7 map[string]string, arg8 bool, arg9 string, arg10 bool) (*models.ActualLRP, *models.ActualLRP, error) {
	var arg6Copy []*models.ActualLRPInternalRoute
	if arg6 != nil {
		arg6Copy = make([]*models.ActualLRPInternalRoute, len(arg6))
		copy(arg6Copy, arg6)
...
func (fake *FakeDB) StartActualLRPCalls(stub func(context.Context, lager.Logger, *models.ActualLRPKey, *models.ActualLRPInstanceKey, *models.ActualLRPNetInfo, []*models.ActualLRPInternalRoute, map[string]string, bool, string, bool) (*models.ActualLRP, *models.ActualLRP, error)) {
	fake.startActualLRPMutex.Lock()
	defer fake.startActualLRPMutex.Unlock()
	fake.StartActualLRPStub = stub
}

func (fake *FakeDB) StartActualLRPArgsForCall(i int) (context.Context, lager.Logger, *models.ActualLRPKey, *models.ActualLRPInstanceKey, *models.ActualLRPNetInfo, []*models.ActualLRPInternalRoute, map[string]string, bool, string, bool) {
	fake.startActualLRPMutex.RLock()
	defer fake.startActualLRPMutex.RUnlock()
...
func (fake *FakeDB) UnclaimActualLRP(arg1 context.Context, arg2 lager.Logger, arg3 bool, arg4 *models.ActualLRPKey) (*models.ActualLRP, *models.ActualLRP, error) {
...
func (fake *FakeDB) UnclaimActualLRPCalls(stub func(context.Context, lager.Logger, bool, *models.ActualLRPKey) (*models.ActualLRP, *models.ActualLRP, error)) {
	fake.unclaimActualLRPMutex.Lock()
	defer fake.unclaimActualLRPMutex.Unlock()
	fake.UnclaimActualLRPStub = stub
}

func (fake *FakeDB) UnclaimActualLRPArgsForCall(i int) (context.Context, lager.Logger, bool, *models.ActualLRPKey) {
	fake.unclaimActualLRPMutex.RLock()
	defer fake.unclaimActualLRPMutex.RUnlock()
