...
func (fake *FakeDB) FailTask(logger lager.Logger, taskGuid string, failureReason string) (before *models.Task, after *models.Task, shouldRestart bool, err error) {
...
func (fake *FakeDB) FailTaskReturns(result1 *models.Task, result2 *models.Task, result3 bool, result4 error) {
...
func (fake *FakeDB) FailTaskReturnsOnCall(i int, result1 *models.Task, result2 *models.Task, result3 bool, result4 error) {
	fake.FailTaskStub = nil
