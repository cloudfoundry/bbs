...
var _ = Describe("LRPConvergence", func() {
	...
	Context("when the cellset is empty", func() {
		...
		BeforeEach(func() {
			...
			_, _, err = sqlDB.StartActualLRP(ctx, logger, &lrpKey, &models.ActualLRPInstanceKey{InstanceGuid: "ig-1", CellId: "suspect-cell"}, &actualLRPNetInfo, model_helpers.NewActualLRPInternalRoutes(), model_helpers.NewActualLRPMetricTags(), false)
			Expect(err).NotTo(HaveOccurred())
	...
	Context("when there is a suspect LRP with an existing cell", func() {
		...
		BeforeEach(func() {
			...
			actualLRPNetInfo := models.NewActualLRPNetInfo("some-address", "container-address", models.ActualLRPNetInfo_PreferredAddressUnknown, models.NewPortMapping(2222, 4444))
			lrpKey = models.NewActualLRPKey(processGuid, 0, domain)
			_, _, err = sqlDB.StartActualLRP(ctx, logger, &lrpKey, &models.ActualLRPInstanceKey{InstanceGuid: "ig-1", CellId: "existing-cell"}, &actualLRPNetInfo, model_helpers.NewActualLRPInternalRoutes(), model_helpers.NewActualLRPMetricTags(), false)
			Expect(err).NotTo(HaveOccurred())
			_, _, err = sqlDB.ChangeActualLRPPresence(ctx, logger, &lrpKey, models.ActualLRP_Ordinary, models.ActualLRP_Suspect)
			Expect(err).NotTo(HaveOccurred())
			...
			_, _, err = sqlDB.StartActualLRP(ctx, logger, &lrpKey2, &models.ActualLRPInstanceKey{InstanceGuid: "ig-2", CellId: "suspect-cell"}, &actualLRPNetInfo, model_helpers.NewActualLRPInternalRoutes(), model_helpers.NewActualLRPMetricTags(), false)
			Expect(err).NotTo(HaveOccurred())
	...
	Context("when there is a suspect LRP and ordinary LRP present", func() {
		...
		BeforeEach(func() {
			...
			_, _, err = sqlDB.StartActualLRP(ctx, logger, &lrpKey, &models.ActualLRPInstanceKey{InstanceGuid: "ig-2", CellId: "existing-cell"}, &actualLRPNetInfo, model_helpers.NewActualLRPInternalRoutes(), model_helpers.NewActualLRPMetricTags(), false)
			Expect(err).NotTo(HaveOccurred())
	...
	Context("when there are orphaned suspect LRPs", func() {
		...
		BeforeEach(func() {
			...
			_, _, err = sqlDB.StartActualLRP(ctx, logger, &lrpKey3, &models.ActualLRPInstanceKey{InstanceGuid: "ig-3", CellId: "suspect-cell"}, &actualLRPNetInfo, model_helpers.NewActualLRPInternalRoutes(), model_helpers.NewActualLRPMetricTags(), false)
			Expect(err).NotTo(HaveOccurred())
	...
	Context("when the ActualLRPs are crashed and restartable", func() {
		...
		BeforeEach(func() {
			...
			for i := int32(0); i < 2; i++ {
				...
				Expect(err).NotTo(HaveOccurred())
				actualLRPNetInfo := models.NewActualLRPNetInfo("some-address", "container-address", models.ActualLRPNetInfo_PreferredAddressUnknown, models.NewPortMapping(2222, 4444))
				_, _, err = sqlDB.StartActualLRP(ctx, logger, &crashedActualLRPKey, &models.ActualLRPInstanceKey{InstanceGuid: instanceGuid, CellId: "existing-cell"}, &actualLRPNetInfo, model_helpers.NewActualLRPInternalRoutes(), model_helpers.NewActualLRPMetricTags(), false)
				Expect(err).NotTo(HaveOccurred())
	...
	Context("when there are actual LRPs with internal routes different from desired LRP internal routes", func() {
		...
		BeforeEach(func() {
			...
			_, _, err = sqlDB.StartActualLRP(ctx, logger, &lrpKey1, &lrpInstanceKey1, &actualLRPNetInfo, model_helpers.NewActualLRPInternalRoutes(), model_helpers.NewActualLRPMetricTags(), false)
			Expect(err).NotTo(HaveOccurred())

			lrpKey2 = models.NewActualLRPKey(processGuid, 1, domain)
			lrpInstanceKey2 = models.ActualLRPInstanceKey{InstanceGuid: "ig-2", CellId: "existing-cell"}
			_, _, err = sqlDB.StartActualLRP(ctx, logger, &lrpKey2, &lrpInstanceKey2, &actualLRPNetInfo, model_helpers.NewActualLRPInternalRoutes(), model_helpers.NewActualLRPMetricTags(), false)
			Expect(err).NotTo(HaveOccurred())
			...
			_, _, err = sqlDB.StartActualLRP(ctx, logger, &lrpKey3, &lrpInstanceKey3, &actualLRPNetInfo, nil, nil, false)
			Expect(err).NotTo(HaveOccurred())
			...
			_, _, err = sqlDB.StartActualLRP(ctx, logger, &lrpKey4, &lrpInstanceKey4, &actualLRPNetInfo, sameInternalRoutes, model_helpers.NewActualLRPMetricTags(), false)
			Expect(err).NotTo(HaveOccurred())
			...
			_, _, err = sqlDB.StartActualLRP(ctx, logger, &lrpKey5, &lrpInstanceKey5, &actualLRPNetInfo, internalRoutesInDifferentOrder, model_helpers.NewActualLRPMetricTags(), false)
			Expect(err).NotTo(HaveOccurred())
	...
	Context("when there are actual LRPs with non-nil metrics tags different from desired LRP metric tags", func() {
		...
		BeforeEach(func() {
			...
			lrpKey3 = models.NewActualLRPKey(processGuid, 2, domain)
			lrpInstanceKey3 = models.ActualLRPInstanceKey{InstanceGuid: "ig-3", CellId: "existing-cell"}
			_, _, err = sqlDB.StartActualLRP(ctx, logger, &lrpKey3, &lrpInstanceKey3, &actualLRPNetInfo, model_helpers.NewActualLRPInternalRoutes(), nil, false)
			Expect(err).NotTo(HaveOccurred())
			...
			_, _, err = sqlDB.StartActualLRP(ctx, logger, &lrpKey4, &lrpInstanceKey4, &actualLRPNetInfo, model_helpers.NewActualLRPInternalRoutes(), sameMetricTags, false)
			Expect(err).NotTo(HaveOccurred())
