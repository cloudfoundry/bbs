...
func (*DesiredLRP) Version() Version {
	return V3
}
...
func (d *DesiredLRP) VersionDownTo(v Version) *DesiredLRP {
	versionedLRP := d.Copy()
...
func (*DesiredLRPSchedulingInfo) Version() Version {
	return V0
}
...
func (*CertificateProperties) Version() Version {
	return V0
}
