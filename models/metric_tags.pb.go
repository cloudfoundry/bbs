...
func (MetricTagValue_DynamicValue) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorMetricTags, []int{0, 0}
}
...
func (*MetricTagValue) Descriptor() ([]byte, []int) { return fileDescriptorMetricTags, []int{0} }
...
func encodeFixed64MetricTags(dAtA []byte, offset int, v uint64) int {
	dAtA[offset] = uint8(v)
...
func encodeFixed32MetricTags(dAtA []byte, offset int, v uint32) int {
	dAtA[offset] = uint8(v)
	dAtA[offset+1] = uint8(v >> 8)
	dAtA[offset+2] = uint8(v >> 16)
	dAtA[offset+3] = uint8(v >> 24)
...
func init() { proto.RegisterFile("metric_tags.proto", fileDescriptorMetricTags) }

var fileDescriptorMetricTags = []byte{
	...
	0x98, 0x05, 0xd1, 0xa6, 0xb4, 0x8a, 0x89, 0x8b, 0xcf, 0x17, 0x6c, 0x58, 0x48, 0x62, 0x7a, 0x58,
	...
	0x2b, 0x08, 0xd5, 0x8b, 0x64, 0x30, 0xcc, 0x38, 0xa5, 0x6e, 0x46, 0x2e, 0x1e, 0x64, 0x4d, 0x42,
	...
	0x9b, 0x51, 0x95, 0xa7, 0xa4, 0x56, 0x08, 0x99, 0x73, 0xf1, 0x78, 0xfa, 0x05, 0x87, 0x38, 0xfa,
	0x39, 0xbb, 0xba, 0x87, 0x7a, 0xba, 0x08, 0x30, 0x49, 0xa9, 0x76, 0xcd, 0x55, 0x50, 0xc4, 0xa1,
	0xa3, 0xb8, 0x24, 0x31, 0x2f, 0x39, 0xd5, 0xbd, 0x34, 0x33, 0xc5, 0x49, 0xe7, 0xc2, 0x43, 0x39,
	...
	0x91, 0x1c, 0xc3, 0x87, 0x47, 0x72, 0x8c, 0x13, 0x1e, 0xcb, 0x31, 0x00, 0x02, 0x00, 0x00, 0xff,
	0xff, 0x2a, 0x7a, 0xa1, 0x68, 0xa5, 0x01, 0x00, 0x00,
}
