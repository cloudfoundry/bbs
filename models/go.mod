...
replace (
	code.cloudfoundry.org/bbs => code.cloudfoundry.org/bbs v0.0.0-20260202181326-35b5f7d1d955
	code.cloudfoundry.org/bbs/db/sqldb/helpers => ../db/sqldb/helpers
...
require (
	code.cloudfoundry.org/bbs/db/sqldb/helpers v0.0.0-00010101000000-000000000000 // indirect
