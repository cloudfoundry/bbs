...
var file_ping_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x6c, 0x73, 0x22, 0x31, 0x0a, 0x11, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x69, 0x6e,
	0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x61, 0x76, 0x61,
...
func file_ping_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_ping_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtoPingResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
