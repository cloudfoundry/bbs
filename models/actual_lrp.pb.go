...
type ActualLRPKey struct {
	...
	LrpDeploymentGuid string `protobuf:"bytes,4,opt,name=lrp_deployment_guid,json=lrpDeploymentGuid" json:"lrp_deployment_guid"`
}
...
func (m *ActualLRPKey) GetLrpDeploymentGuid() string {
	if m != nil {
		return m.LrpDeploymentGuid
	}
	return ""
}
...
func (this *ActualLRPKey) Equal(that interface{}) bool {
	...
	if this.LrpDeploymentGuid != that1.LrpDeploymentGuid {
		return false
	}
	return true
}
...
func (this *ActualLRPKey) GoString() string {
	...
	s = append(s, "LrpDeploymentGuid: "+fmt.Sprintf("%#v", this.LrpDeploymentGuid)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *ActualLRPKey) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x22
	i++
	i = encodeVarintActualLrp(dAtA, i, uint64(len(m.LrpDeploymentGuid)))
	i += copy(dAtA[i:], m.LrpDeploymentGuid)
	return i, nil
}
...
func (this *ActualLRPKey) String() string {
	...
	s := strings.Join([]string{`&ActualLRPKey{`,
		...
		`LrpDeploymentGuid:` + fmt.Sprintf("%v", this.LrpDeploymentGuid) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ActualLRPKey) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LrpDeploymentGuid", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LrpDeploymentGuid = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipActualLrp(dAtA[iNdEx:])
...
var fileDescriptorActualLrp = []byte{
	...
	,
}
