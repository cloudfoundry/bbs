...
type ActualLRPGroup struct {
	...
	Suspect    *ActualLRP `protobuf:"bytes,3,opt,name=suspect" json:"suspect,omitempty"`
}
...
func (m *ActualLRPGroup) GetSuspect() *ActualLRP {
	if m != nil {
		return m.Suspect
	}
	return nil
...
func (this *ActualLRPGroup) Equal(that interface{}) bool {
	...
	if !this.Suspect.Equal(that1.Suspect) {
		return false
	}
	return true
}
...
func (this *ActualLRPGroup) GoString() string {
	...
	if this.Suspect != nil {
		s = append(s, "Suspect: "+fmt.Sprintf("%#v", this.Suspect)+",\n")
	}
	s = append(s, "}")
...
func (m *ActualLRPGroup) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Suspect != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintActualLrp(dAtA, i, uint64(m.Suspect.Size()))
		n3, err := m.Suspect.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (this *ActualLRPGroup) String() string {
	...
	s := strings.Join([]string{`&ActualLRPGroup{`,
		...
		`Suspect:` + strings.Replace(fmt.Sprintf("%v", this.Suspect), "ActualLRP", "ActualLRP", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ActualLRPGroup) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Suspect", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.Suspect.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorActualLrp = []byte{
	...
	,
}
