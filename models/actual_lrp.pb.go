...
func (x Presence) MarshalJSON() ([]byte, error) {
	return proto.MarshalJSONEnum(Presence_name, int32(x))
}
func (x *Presence) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(Presence_value, data, "Presence")
	if err != nil {
		return err
	}
	*x = Presence(value)
...
func (Presence) EnumDescriptor() ([]byte, []int) { return fileDescriptorActualLrp, []int{0} }
...
type ActualLRP struct {
	...
	Presence             Presence        `protobuf:"varint,10,opt,name=presence,enum=models.Presence" json:"presence"`
}
...
func (m *ActualLRP) GetPresence() Presence {
	if m != nil {
		return m.Presence
	}
	return ordinary
...
func init() {
	...
	proto.RegisterEnum("models.Presence", Presence_name, Presence_value)
}
func (x Presence) String() string {
	s, ok := Presence_name[int32(x)]
	if ok {
		return s
	}
...
var fileDescriptorActualLrp = []byte{
	...
	,
}
