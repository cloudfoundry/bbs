...
type ActualLRP struct {
	...
	Presence             string          `protobuf:"bytes,10,opt,name=presence" json:"presence"`
}
...
func (m *ActualLRP) GetPresence() string {
	if m != nil {
		return m.Presence
	}
	return ""
...
func (m *ActualLRP) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x52
	i++
	i = encodeVarintActualLrp(dAtA, i, uint64(len(m.Presence)))
	i += copy(dAtA[i:], m.Presence)
	return i, nil
}
...
func (m *ActualLRP) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			m.Presence = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipActualLrp(dAtA[iNdEx:])
...
var fileDescriptorActualLrp = []byte{
	...
	,
}
