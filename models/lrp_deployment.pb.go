...
type LRPDeploymentSchedulingInfo struct {
	ProcessGuid     string `protobuf:"bytes,1,opt,name=process_guid,json=processGuid" json:"process_guid"`
	Domain          string `protobuf:"bytes,2,opt,name=domain" json:"domain"`
	Instances       int32  `protobuf:"varint,3,opt,name=instances" json:"instances"`
	Annotation      string `protobuf:"bytes,4,opt,name=annotation" json:"annotation"`
	ModificationTag `protobuf:"bytes,5,opt,name=modification_tag,json=modificationTag,embedded=modification_tag" json:""`
	Routes          *Routes                                 `protobuf:"bytes,6,opt,name=routes,customtype=Routes" json:"routes,omitempty"`
	Definitions     map[string]*LRPDefinitionSchedulingInfo `protobuf:"bytes,7,rep,name=definitions" json:"definitions,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}

func (m *LRPDeploymentSchedulingInfo) Reset()      { *m = LRPDeploymentSchedulingInfo{} }
func (*LRPDeploymentSchedulingInfo) ProtoMessage() {}
func (*LRPDeploymentSchedulingInfo) Descriptor() ([]byte, []int) {
	return fileDescriptorLrpDeployment, []int{4}
}

func (m *LRPDeploymentSchedulingInfo) GetProcessGuid() string {
	if m != nil {
		return m.ProcessGuid
	}
	return ""
...
func (m *LRPDeploymentSchedulingInfo) GetDomain() string {
	if m != nil {
		return m.Domain
	}
	return ""
...
func (m *LRPDeploymentSchedulingInfo) GetInstances() int32 {
	if m != nil {
		return m.Instances
	}
	return 0
...
func (m *LRPDeploymentSchedulingInfo) GetAnnotation() string {
	if m != nil {
		return m.Annotation
	}
	return ""
...
func (m *LRPDeploymentSchedulingInfo) GetDefinitions() map[string]*LRPDefinitionSchedulingInfo {
	if m != nil {
		return m.Definitions
	}
	return nil
...
type LRPDefinitionSchedulingInfo struct {
	DefinitionId    string           `protobuf:"bytes,1,opt,name=definition_id,json=definitionId" json:"definition_id"`
	LogGuid         string           `protobuf:"bytes,2,opt,name=log_guid,json=logGuid" json:"log_guid"`
	MemoryMb        int32            `protobuf:"varint,3,opt,name=memory_mb,json=memoryMb" json:"memory_mb"`
	DiskMb          int32            `protobuf:"varint,4,opt,name=disk_mb,json=diskMb" json:"disk_mb"`
	RootFs          string           `protobuf:"bytes,5,opt,name=root_fs,json=rootFs" json:"rootfs"`
	MaxPids         int32            `protobuf:"varint,6,opt,name=max_pids,json=maxPids" json:"max_pids"`
	Ports           []uint32         `protobuf:"varint,7,rep,name=ports" json:"ports,omitempty"`
	VolumePlacement *VolumePlacement `protobuf:"bytes,8,opt,name=volume_placement,json=volumePlacement" json:"volume_placement,omitempty"`
	PlacementTags   []string         `protobuf:"bytes,9,rep,name=PlacementTags" json:"placement_tags,omitempty"`
}

func (m *LRPDefinitionSchedulingInfo) Reset()      { *m = LRPDefinitionSchedulingInfo{} }
func (*LRPDefinitionSchedulingInfo) ProtoMessage() {}
func (*LRPDefinitionSchedulingInfo) Descriptor() ([]byte, []int) {
	return fileDescriptorLrpDeployment, []int{5}
}

func (m *LRPDefinitionSchedulingInfo) GetDefinitionId() string {
	if m != nil {
		return m.DefinitionId
	}
	return ""
...
func (m *LRPDefinitionSchedulingInfo) GetLogGuid() string {
	if m != nil {
		return m.LogGuid
	}
	return ""
...
func (m *LRPDefinitionSchedulingInfo) GetMemoryMb() int32 {
	if m != nil {
		return m.MemoryMb
	}
	return 0
...
func (m *LRPDefinitionSchedulingInfo) GetDiskMb() int32 {
	if m != nil {
		return m.DiskMb
	}
	return 0
...
func (m *LRPDefinitionSchedulingInfo) GetRootFs() string {
	if m != nil {
		return m.RootFs
	}
	return ""
...
func (m *LRPDefinitionSchedulingInfo) GetMaxPids() int32 {
	if m != nil {
		return m.MaxPids
	}
	return 0
...
func (m *LRPDefinitionSchedulingInfo) GetPorts() []uint32 {
	if m != nil {
		return m.Ports
	}
	return nil
...
func (m *LRPDefinitionSchedulingInfo) GetVolumePlacement() *VolumePlacement {
	if m != nil {
		return m.VolumePlacement
	}
	return nil
...
func (m *LRPDefinitionSchedulingInfo) GetPlacementTags() []string {
	if m != nil {
		return m.PlacementTags
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*LRPDeploymentSchedulingInfo)(nil), "models.LRPDeploymentSchedulingInfo")
	proto.RegisterType((*LRPDefinitionSchedulingInfo)(nil), "models.LRPDefinitionSchedulingInfo")
}
...
func (this *LRPDeploymentSchedulingInfo) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*LRPDeploymentSchedulingInfo)
	if !ok {
		that2, ok := that.(LRPDeploymentSchedulingInfo)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *LRPDefinitionSchedulingInfo) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*LRPDefinitionSchedulingInfo)
	if !ok {
		that2, ok := that.(LRPDefinitionSchedulingInfo)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *LRPDeploymentSchedulingInfo) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 11)
	s = append(s, "&models.LRPDeploymentSchedulingInfo{")
	s = append(s, "ProcessGuid: "+fmt.Sprintf("%#v", this.ProcessGuid)+",\n")
	s = append(s, "Domain: "+fmt.Sprintf("%#v", this.Domain)+",\n")
	s = append(s, "Instances: "+fmt.Sprintf("%#v", this.Instances)+",\n")
	s = append(s, "Annotation: "+fmt.Sprintf("%#v", this.Annotation)+",\n")
	...
	github_com_gogo_protobuf_sortkeys.Strings(keysForDefinitions)
	mapStringForDefinitions := "map[string]*LRPDefinitionSchedulingInfo{"
	for _, k := range keysForDefinitions {
		mapStringForDefinitions += fmt.Sprintf("%#v: %#v,", k, this.Definitions[k])
	}
	mapStringForDefinitions += "}"
...
func (this *LRPDefinitionSchedulingInfo) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 13)
	s = append(s, "&models.LRPDefinitionSchedulingInfo{")
	s = append(s, "DefinitionId: "+fmt.Sprintf("%#v", this.DefinitionId)+",\n")
	s = append(s, "LogGuid: "+fmt.Sprintf("%#v", this.LogGuid)+",\n")
	s = append(s, "MemoryMb: "+fmt.Sprintf("%#v", this.MemoryMb)+",\n")
	s = append(s, "DiskMb: "+fmt.Sprintf("%#v", this.DiskMb)+",\n")
...
func (m *LRPDeploymentSchedulingInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *LRPDeploymentSchedulingInfo) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *LRPDefinitionSchedulingInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *LRPDefinitionSchedulingInfo) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.VolumePlacement != nil {
		...
		i++
		i = encodeVarintLrpDeployment(dAtA, i, uint64(m.VolumePlacement.Size()))
		n18, err := m.VolumePlacement.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
...
func (m *LRPDeploymentSchedulingInfo) Size() (n int) {
	var l int
	_ = l
	l = len(m.ProcessGuid)
	n += 1 + l + sovLrpDeployment(uint64(l))
...
func (m *LRPDefinitionSchedulingInfo) Size() (n int) {
	var l int
	_ = l
	l = len(m.DefinitionId)
	n += 1 + l + sovLrpDeployment(uint64(l))
	...
	l = len(m.RootFs)
	n += 1 + l + sovLrpDeployment(uint64(l))
	n += 1 + sovLrpDeployment(uint64(m.MaxPids))
	if len(m.Ports) > 0 {
		for _, e := range m.Ports {
			n += 1 + sovLrpDeployment(uint64(e))
		}
...
func (this *LRPDeploymentSchedulingInfo) String() string {
	if this == nil {
		return "nil"
	}
	keysForDefinitions := make([]string, 0, len(this.Definitions))
	...
	mapStringForDefinitions += "}"
	s := strings.Join([]string{`&LRPDeploymentSchedulingInfo{`,
		`ProcessGuid:` + fmt.Sprintf("%v", this.ProcessGuid) + `,`,
		`Domain:` + fmt.Sprintf("%v", this.Domain) + `,`,
		`Instances:` + fmt.Sprintf("%v", this.Instances) + `,`,
		`Annotation:` + fmt.Sprintf("%v", this.Annotation) + `,`,
...
func (this *LRPDefinitionSchedulingInfo) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&LRPDefinitionSchedulingInfo{`,
		`DefinitionId:` + fmt.Sprintf("%v", this.DefinitionId) + `,`,
		`LogGuid:` + fmt.Sprintf("%v", this.LogGuid) + `,`,
		`MemoryMb:` + fmt.Sprintf("%v", this.MemoryMb) + `,`,
		`DiskMb:` + fmt.Sprintf("%v", this.DiskMb) + `,`,
...
func (m *LRPDeploymentSchedulingInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LRPDeploymentSchedulingInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LRPDeploymentSchedulingInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 7:
			...
			iNdEx = postStringIndexmapkey
			if m.Definitions == nil {
				m.Definitions = make(map[string]*LRPDefinitionSchedulingInfo)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
				...
				mapvalue := &LRPDefinitionSchedulingInfo{}
				if err := mapvalue.Unmarshal(dAtA[iNdEx:postmsgIndex]); err != nil {
					return err
				}
				iNdEx = postmsgIndex
				...
				var mapvalue *LRPDefinitionSchedulingInfo
				m.Definitions[mapkey] = mapvalue
			}
			iNdEx = postIndex
		default:
...
func (m *LRPDefinitionSchedulingInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LRPDefinitionSchedulingInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LRPDefinitionSchedulingInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorLrpDeployment = []byte{
	...
	,
}
