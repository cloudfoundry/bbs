...
type LRPDefinition struct {
	...
	ModificationTag               *ModificationTag       `protobuf:"bytes,17,opt,name=modification_tag,json=modificationTag" json:"modification_tag,omitempty"`
	...
	PlacementTags                 []string               `protobuf:"bytes,23,rep,name=PlacementTags" json:"placement_tags,omitempty"`
...
func (m *LRPDefinition) GetModificationTag() *ModificationTag {
	if m != nil {
...
func (m *LRPDeploymentDefinition) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Definition != nil {
		...
		n4, err := m.Definition.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *LRPDeploymentUpdate) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Routes != nil {
		...
		i++
		i = encodeVarintLrpDeployment(dAtA, i, uint64(m.Routes.Size()))
		n5, err := m.Routes.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *LRPDefinition) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ModificationTag != nil {
		...
		n10, err := m.ModificationTag.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
var fileDescriptorLrpDeployment = []byte{
	...
	,
}
