...
func (*CellCapacity) Descriptor() ([]byte, []int) {
	return fileDescriptor_cells_161e8de2cf748010, []int{0}
}
...
type CellPresence struct {
	...
	RepAddress            string        `protobuf:"bytes,2,opt,name=rep_address,json=repAddress,proto3" json:"rep_address,omitempty"`
	...
	RepUrl                string        `protobuf:"bytes,8,opt,name=rep_url,json=repUrl,proto3" json:"rep_url,omitempty"`
}

func (m *CellPresence) Reset()      { *m = CellPresence{} }
func (*CellPresence) ProtoMessage() {}
func (*CellPresence) Descriptor() ([]byte, []int) {
	return fileDescriptor_cells_161e8de2cf748010, []int{1}
}
...
func (*Provider) Descriptor() ([]byte, []int) {
	return fileDescriptor_cells_161e8de2cf748010, []int{2}
}
...
func (*CellsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cells_161e8de2cf748010, []int{3}
}
...
func init() { proto.RegisterFile("cells.proto", fileDescriptor_cells_161e8de2cf748010) }

var fileDescriptor_cells_161e8de2cf748010 = []byte{
	// 533 bytes of a gzipped FileDescriptorProto
	,
}
