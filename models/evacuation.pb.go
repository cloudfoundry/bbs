...
type EvacuationResponse struct {
	...
	KeepContainer bool   `protobuf:"varint,2,opt,name=keep_container,json=keepContainer,proto3" json:"keep_container,omitempty"`
}
...
func (*EvacuationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_evacuation_f448cfe61203d8e3, []int{0}
}
...
func (*EvacuateClaimedActualLRPRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_evacuation_f448cfe61203d8e3, []int{1}
}
...
func (*EvacuateRunningActualLRPRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_evacuation_f448cfe61203d8e3, []int{2}
}
...
func (*EvacuateStoppedActualLRPRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_evacuation_f448cfe61203d8e3, []int{3}
}
...
func (*EvacuateCrashedActualLRPRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_evacuation_f448cfe61203d8e3, []int{4}
}
...
func (*RemoveEvacuatingActualLRPRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_evacuation_f448cfe61203d8e3, []int{5}
}
...
func (*RemoveEvacuatingActualLRPResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_evacuation_f448cfe61203d8e3, []int{6}
}
...
func init() { proto.RegisterFile("evacuation.proto", fileDescriptor_evacuation_f448cfe61203d8e3) }

var fileDescriptor_evacuation_f448cfe61203d8e3 = []byte{
	// 445 bytes of a gzipped FileDescriptorProto
	,
}
