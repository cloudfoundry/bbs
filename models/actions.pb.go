...
type RunAction struct {
	...
	SuppressHealthcheckExitCode bool                   `protobuf:"varint,9,opt,name=suppress_healthcheck_exit_code,json=suppressHealthcheckExitCode" json:"suppress_healthcheck_exit_code"`
}
...
func (m *RunAction) GetSuppressHealthcheckExitCode() bool {
	if m != nil {
		return m.SuppressHealthcheckExitCode
	}
	return false
}
...
func (this *RunAction) Equal(that interface{}) bool {
	...
	if this.SuppressHealthcheckExitCode != that1.SuppressHealthcheckExitCode {
		return false
	}
	return true
}
...
func (this *RunAction) GoString() string {
	...
	s = append(s, "SuppressHealthcheckExitCode: "+fmt.Sprintf("%#v", this.SuppressHealthcheckExitCode)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *RunAction) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x48
	i++
	if m.SuppressHealthcheckExitCode {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (this *RunAction) String() string {
	...
	s := strings.Join([]string{`&RunAction{`,
		...
		`SuppressHealthcheckExitCode:` + fmt.Sprintf("%v", this.SuppressHealthcheckExitCode) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *RunAction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SuppressHealthcheckExitCode", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SuppressHealthcheckExitCode = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipActions(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorActions = []byte{
	...
	,
}
