...
type ProtoActualLRPsByProcessGuidsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Error         *ProtoError            `protobuf:"bytes,1,opt,name=error,proto3" json:"error,omitempty"`
...
func (x *ProtoActualLRPsByProcessGuidsResponse) Reset() {
	*x = ProtoActualLRPsByProcessGuidsResponse{}
	mi := &file_actual_lrp_requests_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProtoActualLRPsByProcessGuidsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProtoActualLRPsByProcessGuidsResponse) ProtoMessage() {}

func (x *ProtoActualLRPsByProcessGuidsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_actual_lrp_requests_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProtoActualLRPsByProcessGuidsResponse.ProtoReflect.Descriptor instead.
func (*ProtoActualLRPsByProcessGuidsResponse) Descriptor() ([]byte, []int) {
	return file_actual_lrp_requests_proto_rawDescGZIP(), []int{14}
}

func (x *ProtoActualLRPsByProcessGuidsResponse) GetError() *ProtoError {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *ProtoActualLRPsByProcessGuidsResponse) GetActualLrps() []*ProtoActualLRP {
	if x != nil {
		return x.ActualLrps
	}
	return nil
...
type ProtoActualLRPsByProcessGuidsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ProcessGuids  []string               `protobuf:"bytes,1,rep,name=process_guids,proto3" json:"process_guids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ProtoActualLRPsByProcessGuidsRequest) Reset() {
	*x = ProtoActualLRPsByProcessGuidsRequest{}
	mi := &file_actual_lrp_requests_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProtoActualLRPsByProcessGuidsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProtoActualLRPsByProcessGuidsRequest) ProtoMessage() {}

func (x *ProtoActualLRPsByProcessGuidsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_actual_lrp_requests_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProtoActualLRPsByProcessGuidsRequest.ProtoReflect.Descriptor instead.
func (*ProtoActualLRPsByProcessGuidsRequest) Descriptor() ([]byte, []int) {
	return file_actual_lrp_requests_proto_rawDescGZIP(), []int{15}
}

func (x *ProtoActualLRPsByProcessGuidsRequest) GetProcessGuids() []string {
	if x != nil {
...
const file_actual_lrp_requests_proto_rawDesc = "" +
	...
	"\x06_index\"\x8a\x01\n" +
	"%ProtoActualLRPsByProcessGuidsResponse\x12(\n" +
	"\x05error\x18\x01 \x01(\v2\x12.models.ProtoErrorR\x05error\x127\n" +
	"\vactual_lrps\x18\x02 \x03(\v2\x16.models.ProtoActualLRPR\n" +
	"actualLrps\"L\n" +
	"$ProtoActualLRPsByProcessGuidsRequest\x12$\n" +
	"\rprocess_guids\x18\x01 \x03(\tR\rprocess_guidsB\"Z code.cloudfoundry.org/bbs/modelsb\x06proto3"
...
var file_actual_lrp_requests_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_actual_lrp_requests_proto_goTypes = []any{
	...
	(*ProtoActualLRPsByProcessGuidsResponse)(nil),           // 14: models.ProtoActualLRPsByProcessGuidsResponse
	(*ProtoActualLRPsByProcessGuidsRequest)(nil),            // 15: models.ProtoActualLRPsByProcessGuidsRequest
	nil,                                 // 16: models.ProtoStartActualLRPRequest.MetricTagsEntry
	(*ProtoError)(nil),                  // 17: models.ProtoError
	(*ProtoActualLRPGroup)(nil),         // 18: models.ProtoActualLRPGroup
	(*ProtoActualLRPInstanceKey)(nil),   // 19: models.ProtoActualLRPInstanceKey
	(*ProtoActualLRPKey)(nil),           // 20: models.ProtoActualLRPKey
	(*ProtoActualLRPNetInfo)(nil),       // 21: models.ProtoActualLRPNetInfo
	(*ProtoActualLRPInternalRoute)(nil), // 22: models.ProtoActualLRPInternalRoute
	(*ProtoActualLRP)(nil),              // 23: models.ProtoActualLRP
}
var file_actual_lrp_requests_proto_depIdxs = []int32{
	17, // 0: models.ProtoActualLRPLifecycleResponse.error:type_name -> models.ProtoError
	17, // 1: models.ProtoActualLRPGroupsResponse.error:type_name -> models.ProtoError
	18, // 2: models.ProtoActualLRPGroupsResponse.actual_lrp_groups:type_name -> models.ProtoActualLRPGroup
	17, // 3: models.ProtoActualLRPGroupResponse.error:type_name -> models.ProtoError
	18, // 4: models.ProtoActualLRPGroupResponse.actual_lrp_group:type_name -> models.ProtoActualLRPGroup
	19, // 5: models.ProtoClaimActualLRPRequest.actual_lrp_instance_key:type_name -> models.ProtoActualLRPInstanceKey
	20, // 6: models.ProtoStartActualLRPRequest.actual_lrp_key:type_name -> models.ProtoActualLRPKey
	19, // 7: models.ProtoStartActualLRPRequest.actual_lrp_instance_key:type_name -> models.ProtoActualLRPInstanceKey
	21, // 8: models.ProtoStartActualLRPRequest.actual_lrp_net_info:type_name -> models.ProtoActualLRPNetInfo
	22, // 9: models.ProtoStartActualLRPRequest.actual_lrp_internal_routes:type_name -> models.ProtoActualLRPInternalRoute
	16, // 10: models.ProtoStartActualLRPRequest.metric_tags:type_name -> models.ProtoStartActualLRPRequest.MetricTagsEntry
	20, // 11: models.ProtoCrashActualLRPRequest.actual_lrp_key:type_name -> models.ProtoActualLRPKey
	19, // 12: models.ProtoCrashActualLRPRequest.actual_lrp_instance_key:type_name -> models.ProtoActualLRPInstanceKey
	20, // 13: models.ProtoFailActualLRPRequest.actual_lrp_key:type_name -> models.ProtoActualLRPKey
	20, // 14: models.ProtoRetireActualLRPRequest.actual_lrp_key:type_name -> models.ProtoActualLRPKey
	19, // 15: models.ProtoRemoveActualLRPRequest.actual_lrp_instance_key:type_name -> models.ProtoActualLRPInstanceKey
	17, // 16: models.ProtoActualLRPsResponse.error:type_name -> models.ProtoError
	23, // 17: models.ProtoActualLRPsResponse.actual_lrps:type_name -> models.ProtoActualLRP
	17, // 18: models.ProtoActualLRPsByProcessGuidsResponse.error:type_name -> models.ProtoError
	23, // 19: models.ProtoActualLRPsByProcessGuidsResponse.actual_lrps:type_name -> models.ProtoActualLRP
