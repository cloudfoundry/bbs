...
type ProtoDesiredLRPsRequest struct {
	...
	AppGuids      []string               `protobuf:"bytes,3,rep,name=app_guids,proto3" json:"app_guids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ProtoDesiredLRPsRequest) GetAppGuids() []string {
	if x != nil {
		return x.AppGuids
	}
	return nil
...
const file_desired_lrp_requests_proto_rawDesc = "" +
	...
	"\fdesired_lrps\x18\x02 \x03(\v2\x17.models.ProtoDesiredLRPR\fdesired_lrps\"z\n" +
	"\x17ProtoDesiredLRPsRequest\x12\x1b\n" +
	"\x06domain\x18\x01 \x01(\tB\x03\xc0>\x01R\x06domain\x12$\n" +
	"\rprocess_guids\x18\x02 \x03(\tR\rprocess_guids\x12\x1c\n" +
	"\tapp_guids\x18\x03 \x03(\tR\tapp_guids\"~\n" +
