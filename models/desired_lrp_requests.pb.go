...
type DesiredLRPsRequest struct {
	...
	SkipEgressRules bool     `protobuf:"varint,3,opt,name=skip_egress_rules,json=skipEgressRules,proto3" json:"skip_egress_rules,omitempty"`
}
...
func (m *DesiredLRPsRequest) GetSkipEgressRules() bool {
	if m != nil {
		return m.SkipEgressRules
	}
	return false
}
...
var fileDescriptor_7235cc1a84e38c85 = []byte{
	...
	,
}
...
func (this *DesiredLRPsRequest) Equal(that interface{}) bool {
	...
	if this.SkipEgressRules != that1.SkipEgressRules {
		return false
	}
	return true
}
...
func (this *DesiredLRPsRequest) GoString() string {
	...
	s = append(s, "SkipEgressRules: "+fmt.Sprintf("%#v", this.SkipEgressRules)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *DesiredLRPsRequest) String() string {
	...
	s := strings.Join([]string{`&DesiredLRPsRequest{`,
		...
		`SkipEgressRules:` + fmt.Sprintf("%v", this.SkipEgressRules) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *DesiredLRPsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SkipEgressRules", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
