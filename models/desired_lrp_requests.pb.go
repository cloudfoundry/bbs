...
type DesiredLRPsRequest struct {
	...
	VolumeMountDriver string   `protobuf:"bytes,3,opt,name=volume_mount_driver,json=volumeMountDriver,proto3" json:"volume_mount_driver"`
}
...
func (m *DesiredLRPsRequest) GetVolumeMountDriver() string {
	if m != nil {
		return m.VolumeMountDriver
	}
	return ""
}
...
var fileDescriptor_7235cc1a84e38c85 = []byte{
	...
	,
}
...
func (this *DesiredLRPsRequest) Equal(that interface{}) bool {
	...
	if this.VolumeMountDriver != that1.VolumeMountDriver {
		return false
	}
	return true
}
...
func (this *DesiredLRPsRequest) GoString() string {
	...
	s = append(s, "VolumeMountDriver: "+fmt.Sprintf("%#v", this.VolumeMountDriver)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *DesiredLRPsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.VolumeMountDriver) > 0 {
		i -= len(m.VolumeMountDriver)
		copy(dAtA[i:], m.VolumeMountDriver)
		i = encodeVarintDesiredLrpRequests(dAtA, i, uint64(len(m.VolumeMountDriver)))
		i--
		dAtA[i] = 0x1a
	}
...
func (this *DesiredLRPsRequest) String() string {
	...
	s := strings.Join([]string{`&DesiredLRPsRequest{`,
		...
		`VolumeMountDriver:` + fmt.Sprintf("%v", this.VolumeMountDriver) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *DesiredLRPsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VolumeMountDriver", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VolumeMountDriver = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipDesiredLrpRequests(dAtA[iNdEx:])
