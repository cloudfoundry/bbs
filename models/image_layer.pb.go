...
const file_image_layer_proto_rawDesc = "" +
	"\n" +
	...
	"\tEXCLUSIVE\x10\x02\x1a\x15\x82}\x12LayerTypeExclusiveB\"Z code.cloudfoundry.org/bbs/modelsb\x06proto3"

var (
	file_image_layer_proto_rawDescOnce sync.Once
	file_image_layer_proto_rawDescData []byte
)

func file_image_layer_proto_rawDescGZIP() []byte {
	file_image_layer_proto_rawDescOnce.Do(func() {
		file_image_layer_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_image_layer_proto_rawDesc), len(file_image_layer_proto_rawDesc)))
	})
...
func file_image_layer_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_image_layer_proto_rawDesc), len(file_image_layer_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
