...
func (Task_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_task_caaede759c2af501, []int{1, 0}
}
...
func (*TaskDefinition) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_caaede759c2af501, []int{0}
}
...
type Task struct {
	*TaskDefinition  `protobuf:"bytes,1,opt,name=task_definition,json=taskDefinition,proto3,embedded=task_definition" json:""`
	...
	RejectionCount   int32      `protobuf:"varint,12,opt,name=rejection_count,json=rejectionCount,proto3" json:"rejection_count,omitempty"`
...
func (*Task) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_caaede759c2af501, []int{1}
}
...
func init() { proto.RegisterFile("task.proto", fileDescriptor_task_caaede759c2af501) }

var fileDescriptor_task_caaede759c2af501 = []byte{
	...
	,
}
