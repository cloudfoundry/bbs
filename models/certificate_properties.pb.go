...
func (*CertificateProperties) Descriptor() ([]byte, []int) {
	return fileDescriptor_certificate_properties_5ba4b59278fbb740, []int{0}
}
...
func init() {
	proto.RegisterFile("certificate_properties.proto", fileDescriptor_certificate_properties_5ba4b59278fbb740)
}

var fileDescriptor_certificate_properties_5ba4b59278fbb740 = []byte{
