...
type CertificateProperties struct {
	OrganizationalUnits []string `protobuf:"bytes,1,rep,name=organizational_units,json=organizationalUnits" json:"organizational_units,omitempty"`
}
...
func (m *CertificateProperties) GetOrganizationalUnits() []string {
	if m != nil {
...
func (this *CertificateProperties) Equal(that interface{}) bool {
	...
	if len(this.OrganizationalUnits) != len(that1.OrganizationalUnits) {
		return false
	}
	for i := range this.OrganizationalUnits {
		if this.OrganizationalUnits[i] != that1.OrganizationalUnits[i] {
			return false
		}
	}
	return true
...
func (this *CertificateProperties) GoString() string {
	...
	if this.OrganizationalUnits != nil {
		s = append(s, "OrganizationalUnits: "+fmt.Sprintf("%#v", this.OrganizationalUnits)+",\n")
	}
	s = append(s, "}")
...
var fileDescriptorCertificateProperties = []byte{
	...
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x09, 0x6e, 0x88, 0x02, 0xff, 0xe2, 0x92, 0x49, 0x4e, 0x2d, 0x2a,
	0xc9, 0x4c, 0xcb, 0x4c, 0x4e, 0x2c, 0x49, 0x8d, 0x2f, 0x28, 0xca, 0x2f, 0x00, 0x71, 0x53, 0x8b,
	0xf5, 0x0a, 0x8a, 0xf2, 0x4b, 0xf2, 0x85, 0xd8, 0x72, 0xf3, 0x53, 0x52, 0x73, 0x8a, 0x95, 0xbc,
	0xb8, 0x44, 0x9d, 0x11, 0xea, 0x02, 0xe0, 0xca, 0x84, 0x0c, 0xb9, 0x44, 0xf2, 0x8b, 0xd2, 0x13,
	0xf3, 0x32, 0xab, 0x12, 0x4b, 0x32, 0xf3, 0xf3, 0x12, 0x73, 0xe2, 0x4b, 0xf3, 0x32, 0x4b, 0x8a,
	0x25, 0x18, 0x15, 0x98, 0x35, 0x38, 0x83, 0x84, 0x51, 0xe5, 0x42, 0x41, 0x52, 0x4e, 0x3a, 0x17,
	...
	0xc6, 0x17, 0x8f, 0xe4, 0x18, 0x3e, 0x3c, 0x92, 0x63, 0x9c, 0xf0, 0x58, 0x8e, 0x01, 0x10, 0x00,
	0x00, 0xff, 0xff, 0xb5, 0x26, 0xdc, 0x2a, 0xa0, 0x00, 0x00, 0x00,
}
