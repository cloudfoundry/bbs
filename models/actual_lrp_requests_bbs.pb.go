...
// Prevent copylock errors when using ProtoActualLRPsByProcessGuidsResponse directly
type ActualLRPsByProcessGuidsResponse struct {
	Error      *Error       `json:"error,omitempty"`
	ActualLrps []*ActualLRP `json:"actualLrps,omitempty"`
}
...
func (m *ActualLRPsByProcessGuidsResponse) SetError(value *Error) {
	if m != nil {
		m.Error = value
	}
}
...
func (m *ActualLRPsByProcessGuidsResponse) SetActualLrps(value []*ActualLRP) {
	if m != nil {
		m.ActualLrps = value
	}
}
func (x *ActualLRPsByProcessGuidsResponse) ToProto() *ProtoActualLRPsByProcessGuidsResponse {
	if x == nil {
		return nil
	}

	proto := &ProtoActualLRPsByProcessGuidsResponse{
		Error:      x.Error.ToProto(),
		ActualLrps: ActualLRPToProtoSlice(x.ActualLrps),
	}
	return proto
...
func (x *ProtoActualLRPsByProcessGuidsResponse) FromProto() *ActualLRPsByProcessGuidsResponse {
	if x == nil {
		return nil
	}

	copysafe := &ActualLRPsByProcessGuidsResponse{
		Error:      x.Error.FromProto(),
		ActualLrps: ActualLRPFromProtoSlice(x.ActualLrps),
	}
	return copysafe
...
func ActualLRPsByProcessGuidsResponseToProtoSlice(values []*ActualLRPsByProcessGuidsResponse) []*ProtoActualLRPsByProcessGuidsResponse {
	if values == nil {
		return nil
	}
	result := make([]*ProtoActualLRPsByProcessGuidsResponse, len(values))
	for i, val := range values {
		result[i] = val.ToProto()
	}
	return result
...
func ActualLRPsByProcessGuidsResponseFromProtoSlice(values []*ProtoActualLRPsByProcessGuidsResponse) []*ActualLRPsByProcessGuidsResponse {
	if values == nil {
		return nil
	}
	result := make([]*ActualLRPsByProcessGuidsResponse, len(values))
	for i, val := range values {
		result[i] = val.FromProto()
	}
	return result
...
// Prevent copylock errors when using ProtoActualLRPsByProcessGuidsRequest directly
...
func (m *ActualLRPsByProcessGuidsRequest) SetProcessGuids(value []string) {
	if m != nil {
		m.ProcessGuids = value
	}
}
func (x *ActualLRPsByProcessGuidsRequest) ToProto() *ProtoActualLRPsByProcessGuidsRequest {
	if x == nil {
		return nil
	}

	proto := &ProtoActualLRPsByProcessGuidsRequest{
		ProcessGuids: x.ProcessGuids,
	}
	return proto
}

func (x *ProtoActualLRPsByProcessGuidsRequest) FromProto() *ActualLRPsByProcessGuidsRequest {
	if x == nil {
		return nil
	}

	copysafe := &ActualLRPsByProcessGuidsRequest{
		ProcessGuids: x.ProcessGuids,
	}
	return copysafe
}

func ActualLRPsByProcessGuidsRequestToProtoSlice(values []*ActualLRPsByProcessGuidsRequest) []*ProtoActualLRPsByProcessGuidsRequest {
	if values == nil {
		return nil
	}
	result := make([]*ProtoActualLRPsByProcessGuidsRequest, len(values))
	for i, val := range values {
		result[i] = val.ToProto()
	}
	return result
...
func ActualLRPsByProcessGuidsRequestFromProtoSlice(values []*ProtoActualLRPsByProcessGuidsRequest) []*ActualLRPsByProcessGuidsRequest {
	if values == nil {
		return nil
	}
	result := make([]*ActualLRPsByProcessGuidsRequest, len(values))
	for i, val := range values {
		result[i] = val.FromProto()
	}
	return result
