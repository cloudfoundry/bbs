	...
	Describe("DigestAlgorithm", func() {
		Describe("serialization", func() {
			DescribeTable("marshals and unmarshals between the value and the expected JSON output",
				...
				Entry("sha256", models.ImageLayer_DigestAlgorithmSha256, `"SHA256"`),
				Entry("sha512", models.ImageLayer_DigestAlgorithmSha512, `"SHA512"`),
			)
		})
	})
	...
	Describe("MediaType", func() {
		Describe("serialization", func() {
			DescribeTable("marshals and unmarshals between the value and the expected JSON output",
				...
				Entry("tgz", models.ImageLayer_MediaTypeTgz, `"TGZ"`),
				Entry("tar", models.ImageLayer_MediaTypeTar, `"TAR"`),
				Entry("zip", models.ImageLayer_MediaTypeZip, `"ZIP"`),
			)
		})
	})
	...
	Describe("Type", func() {
		Describe("serialization", func() {
			DescribeTable("marshals and unmarshals between the value and the expected JSON output",
				...
				Entry("shared", models.ImageLayer_LayerTypeShared, `"SHARED"`),
				Entry("exclusive", models.ImageLayer_LayerTypeExclusive, `"EXCLUSIVE"`),
			)
		})
	})
})
