...
func main() {
	...
	actualLRPController := controllers.NewActualLRPLifecycleController(activeDB, activeDB, activeDB, activeDB, auctioneerClient, serviceClient, repClientFactory, actualHub)
