...
type FakeRepClientFactory struct {
...
func (fake *FakeRepClientFactory) CreateClient(arg1 string, arg2 string, arg3 string) (models.RepClient, error) {
...
func (fake *FakeRepClientFactory) CreateClientCallCount() int {
	fake.createClientMutex.RLock()
	defer fake.createClientMutex.RUnlock()
	return len(fake.createClientArgsForCall)
}

func (fake *FakeRepClientFactory) CreateClientCalls(stub func(string, string, string) (models.RepClient, error)) {
	fake.createClientMutex.Lock()
	defer fake.createClientMutex.Unlock()
	fake.CreateClientStub = stub
}

func (fake *FakeRepClientFactory) CreateClientArgsForCall(i int) (string, string, string) {
	fake.createClientMutex.RLock()
	defer fake.createClientMutex.RUnlock()
...
func (fake *FakeRepClientFactory) CreateClientReturns(result1 models.RepClient, result2 error) {
	fake.createClientMutex.Lock()
	defer fake.createClientMutex.Unlock()
...
func (fake *FakeRepClientFactory) CreateClientReturnsOnCall(i int, result1 models.RepClient, result2 error) {
	fake.createClientMutex.Lock()
	defer fake.createClientMutex.Unlock()
	fake.CreateClientStub = nil
...
func (fake *FakeRepClientFactory) Invocations() map[string][][]interface{} {
...
func (fake *FakeRepClientFactory) recordInvocation(key string, args []interface{}) {
...
var _ models.RepClientFactory = new(FakeRepClientFactory)
