...
func (fake *FakeInternalClient) CreateLRPDeployment(arg1 lager.Logger, arg2 *models.LRPDeploymentCreation) error {
...
func (fake *FakeInternalClient) CreateLRPDeploymentArgsForCall(i int) (lager.Logger, *models.LRPDeploymentCreation) {
	fake.createLRPDeploymentMutex.RLock()
	defer fake.createLRPDeploymentMutex.RUnlock()
...
func (fake *FakeInternalClient) DeleteLRPDeployment(logger lager.Logger, processGuid string) error {
...
func (fake *FakeInternalClient) DeleteLRPDeploymentCallCount() int {
...
func (fake *FakeInternalClient) DeleteLRPDeploymentArgsForCall(i int) (lager.Logger, string) {
	fake.deleteLRPDeploymentMutex.RLock()
	defer fake.deleteLRPDeploymentMutex.RUnlock()
	return fake.deleteLRPDeploymentArgsForCall[i].logger, fake.deleteLRPDeploymentArgsForCall[i].processGuid
}

func (fake *FakeInternalClient) DeleteLRPDeploymentReturns(result1 error) {
...
func (fake *FakeInternalClient) DeleteLRPDeploymentReturnsOnCall(i int, result1 error) {
	fake.DeleteLRPDeploymentStub = nil
...
func (fake *FakeInternalClient) ActivateLRPDefinition(logger lager.Logger, processGuid string, definitionID string) error {
...
func (fake *FakeInternalClient) ActivateLRPDefinitionCallCount() int {
...
func (fake *FakeInternalClient) ActivateLRPDefinitionArgsForCall(i int) (lager.Logger, string, string) {
	fake.activateLRPDefinitionMutex.RLock()
	defer fake.activateLRPDefinitionMutex.RUnlock()
...
func (fake *FakeInternalClient) ActivateLRPDefinitionReturns(result1 error) {
...
func (fake *FakeInternalClient) ActivateLRPDefinitionReturnsOnCall(i int, result1 error) {
	fake.ActivateLRPDefinitionStub = nil
...
func (fake *FakeInternalClient) LRPDeployments(arg1 lager.Logger, arg2 []string) ([]*models.LRPDeployment, error) {
	var arg2Copy []string
	if arg2 != nil {
...
func (fake *FakeInternalClient) LRPDeploymentsCallCount() int {
	fake.lRPDeploymentsMutex.RLock()
	defer fake.lRPDeploymentsMutex.RUnlock()
	return len(fake.lRPDeploymentsArgsForCall)
}

func (fake *FakeInternalClient) LRPDeploymentsArgsForCall(i int) (lager.Logger, []string) {
	fake.lRPDeploymentsMutex.RLock()
	defer fake.lRPDeploymentsMutex.RUnlock()
	return fake.lRPDeploymentsArgsForCall[i].arg1, fake.lRPDeploymentsArgsForCall[i].arg2
}

func (fake *FakeInternalClient) LRPDeploymentsReturns(result1 []*models.LRPDeployment, result2 error) {
...
func (fake *FakeInternalClient) LRPDeploymentsReturnsOnCall(i int, result1 []*models.LRPDeployment, result2 error) {
	fake.LRPDeploymentsStub = nil
...
func (fake *FakeInternalClient) LRPDeploymentSchedulingInfo(arg1 lager.Logger, arg2 models.LRPDeploymentFilter) ([]*models.LRPDeploymentSchedulingInfo, error) {
...
func (fake *FakeInternalClient) LRPDeploymentSchedulingInfoCallCount() int {
...
func (fake *FakeInternalClient) LRPDeploymentSchedulingInfoArgsForCall(i int) (lager.Logger, models.LRPDeploymentFilter) {
	fake.lRPDeploymentSchedulingInfoMutex.RLock()
	defer fake.lRPDeploymentSchedulingInfoMutex.RUnlock()
	return fake.lRPDeploymentSchedulingInfoArgsForCall[i].arg1, fake.lRPDeploymentSchedulingInfoArgsForCall[i].arg2
}

func (fake *FakeInternalClient) LRPDeploymentSchedulingInfoReturns(result1 []*models.LRPDeploymentSchedulingInfo, result2 error) {
...
func (fake *FakeInternalClient) LRPDeploymentSchedulingInfoReturnsOnCall(i int, result1 []*models.LRPDeploymentSchedulingInfo, result2 error) {
	fake.LRPDeploymentSchedulingInfoStub = nil
