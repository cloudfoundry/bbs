...
func (fake *FakeClient) SubscribeToEventsForCell(logger lager.Logger, cellID string) (events.EventSource, error) {
...
func (fake *FakeClient) SubscribeToEventsForCellCallCount() int {
...
func (fake *FakeClient) SubscribeToEventsForCellArgsForCall(i int) (lager.Logger, string) {
	fake.subscribeToEventsForCellMutex.RLock()
	defer fake.subscribeToEventsForCellMutex.RUnlock()
	return fake.subscribeToEventsForCellArgsForCall[i].logger, fake.subscribeToEventsForCellArgsForCall[i].cellID
}

func (fake *FakeClient) SubscribeToEventsForCellReturns(result1 events.EventSource, result2 error) {
