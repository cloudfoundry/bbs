...
type FakeClient struct {
	...
	CreateLRPDeploymentStub        func(lager.Logger, *models.LRPDeploymentCreation) error
	createLRPDeploymentMutex       sync.RWMutex
	createLRPDeploymentArgsForCall []struct {
		arg1 lager.Logger
		arg2 *models.LRPDeploymentCreation
	}
	...
	DeleteLRPDeploymentStub        func(logger lager.Logger, processGuid string) error
	...
	ActivateLRPDefinitionStub        func(logger lager.Logger, processGuid, definitionID string) error
	activateLRPDefinitionMutex       sync.RWMutex
	activateLRPDefinitionArgsForCall []struct {
		logger       lager.Logger
		processGuid  string
		definitionID string
	}
	activateLRPDefinitionReturns struct {
		result1 error
	}
	activateLRPDefinitionReturnsOnCall map[int]struct {
		result1 error
	}
	LRPDeploymentsStub        func(lager.Logger, []string) ([]*models.LRPDeployment, error)
	...
	LRPDeploymentSchedulingInfoStub        func(lager.Logger, models.LRPDeploymentFilter) ([]*models.LRPDeploymentSchedulingInfo, error)
	lRPDeploymentSchedulingInfoMutex       sync.RWMutex
	lRPDeploymentSchedulingInfoArgsForCall []struct {
		arg1 lager.Logger
		arg2 models.LRPDeploymentFilter
	}
...
func (fake *FakeClient) CreateLRPDeployment(arg1 lager.Logger, arg2 *models.LRPDeploymentCreation) error {
...
func (fake *FakeClient) CreateLRPDeploymentCallCount() int {
...
func (fake *FakeClient) CreateLRPDeploymentArgsForCall(i int) (lager.Logger, *models.LRPDeploymentCreation) {
	fake.createLRPDeploymentMutex.RLock()
	defer fake.createLRPDeploymentMutex.RUnlock()
	return fake.createLRPDeploymentArgsForCall[i].arg1, fake.createLRPDeploymentArgsForCall[i].arg2
}

func (fake *FakeClient) CreateLRPDeploymentReturns(result1 error) {
...
func (fake *FakeClient) CreateLRPDeploymentReturnsOnCall(i int, result1 error) {
	fake.CreateLRPDeploymentStub = nil
...
func (fake *FakeClient) UpdateLRPDeployment(logger lager.Logger, processGuid string, deploymentUpdate *models.LRPDeploymentUpdate) error {
...
func (fake *FakeClient) UpdateLRPDeploymentCallCount() int {
...
func (fake *FakeClient) UpdateLRPDeploymentArgsForCall(i int) (lager.Logger, string, *models.LRPDeploymentUpdate) {
	fake.updateLRPDeploymentMutex.RLock()
	defer fake.updateLRPDeploymentMutex.RUnlock()
...
func (fake *FakeClient) UpdateLRPDeploymentReturns(result1 error) {
...
func (fake *FakeClient) UpdateLRPDeploymentReturnsOnCall(i int, result1 error) {
	fake.UpdateLRPDeploymentStub = nil
...
func (fake *FakeClient) DeleteLRPDeployment(logger lager.Logger, processGuid string) error {
	...
	fake.recordInvocation("DeleteLRPDeployment", []interface{}{logger, processGuid})
	fake.deleteLRPDeploymentMutex.Unlock()
	if fake.DeleteLRPDeploymentStub != nil {
		return fake.DeleteLRPDeploymentStub(logger, processGuid)
	}
	if specificReturn {
		return ret.result1
	}
...
func (fake *FakeClient) DeleteLRPDeploymentCallCount() int {
...
func (fake *FakeClient) DeleteLRPDeploymentArgsForCall(i int) (lager.Logger, string) {
	fake.deleteLRPDeploymentMutex.RLock()
	defer fake.deleteLRPDeploymentMutex.RUnlock()
	return fake.deleteLRPDeploymentArgsForCall[i].logger, fake.deleteLRPDeploymentArgsForCall[i].processGuid
}

func (fake *FakeClient) DeleteLRPDeploymentReturns(result1 error) {
...
func (fake *FakeClient) DeleteLRPDeploymentReturnsOnCall(i int, result1 error) {
	fake.DeleteLRPDeploymentStub = nil
...
func (fake *FakeClient) ActivateLRPDefinition(logger lager.Logger, processGuid string, definitionID string) error {
	fake.activateLRPDefinitionMutex.Lock()
	ret, specificReturn := fake.activateLRPDefinitionReturnsOnCall[len(fake.activateLRPDefinitionArgsForCall)]
	fake.activateLRPDefinitionArgsForCall = append(fake.activateLRPDefinitionArgsForCall, struct {
		logger       lager.Logger
		processGuid  string
		definitionID string
	}{logger, processGuid, definitionID})
	fake.recordInvocation("ActivateLRPDefinition", []interface{}{logger, processGuid, definitionID})
	fake.activateLRPDefinitionMutex.Unlock()
	if fake.ActivateLRPDefinitionStub != nil {
		return fake.ActivateLRPDefinitionStub(logger, processGuid, definitionID)
	}
	if specificReturn {
		return ret.result1
	}
	return fake.activateLRPDefinitionReturns.result1
}

func (fake *FakeClient) ActivateLRPDefinitionCallCount() int {
	fake.activateLRPDefinitionMutex.RLock()
	defer fake.activateLRPDefinitionMutex.RUnlock()
	return len(fake.activateLRPDefinitionArgsForCall)
}

func (fake *FakeClient) ActivateLRPDefinitionArgsForCall(i int) (lager.Logger, string, string) {
	fake.activateLRPDefinitionMutex.RLock()
	defer fake.activateLRPDefinitionMutex.RUnlock()
	return fake.activateLRPDefinitionArgsForCall[i].logger, fake.activateLRPDefinitionArgsForCall[i].processGuid, fake.activateLRPDefinitionArgsForCall[i].definitionID
}

func (fake *FakeClient) ActivateLRPDefinitionReturns(result1 error) {
	fake.ActivateLRPDefinitionStub = nil
	fake.activateLRPDefinitionReturns = struct {
		result1 error
	}{result1}
}

func (fake *FakeClient) ActivateLRPDefinitionReturnsOnCall(i int, result1 error) {
	fake.ActivateLRPDefinitionStub = nil
	if fake.activateLRPDefinitionReturnsOnCall == nil {
		fake.activateLRPDefinitionReturnsOnCall = make(map[int]struct {
			result1 error
		})
	}
	fake.activateLRPDefinitionReturnsOnCall[i] = struct {
		result1 error
	}{result1}
}

func (fake *FakeClient) LRPDeployments(arg1 lager.Logger, arg2 []string) ([]*models.LRPDeployment, error) {
	var arg2Copy []string
	if arg2 != nil {
	...
	fake.recordInvocation("LRPDeployments", []interface{}{arg1, arg2Copy})
	fake.lRPDeploymentsMutex.Unlock()
	if fake.LRPDeploymentsStub != nil {
		return fake.LRPDeploymentsStub(arg1, arg2)
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
...
func (fake *FakeClient) LRPDeploymentsCallCount() int {
	fake.lRPDeploymentsMutex.RLock()
	defer fake.lRPDeploymentsMutex.RUnlock()
	return len(fake.lRPDeploymentsArgsForCall)
}

func (fake *FakeClient) LRPDeploymentsArgsForCall(i int) (lager.Logger, []string) {
	fake.lRPDeploymentsMutex.RLock()
	defer fake.lRPDeploymentsMutex.RUnlock()
	return fake.lRPDeploymentsArgsForCall[i].arg1, fake.lRPDeploymentsArgsForCall[i].arg2
}

func (fake *FakeClient) LRPDeploymentsReturns(result1 []*models.LRPDeployment, result2 error) {
...
func (fake *FakeClient) LRPDeploymentsReturnsOnCall(i int, result1 []*models.LRPDeployment, result2 error) {
	fake.LRPDeploymentsStub = nil
...
func (fake *FakeClient) LRPDeploymentSchedulingInfo(arg1 lager.Logger, arg2 models.LRPDeploymentFilter) ([]*models.LRPDeploymentSchedulingInfo, error) {
	...
	fake.recordInvocation("LRPDeploymentSchedulingInfo", []interface{}{arg1, arg2})
	fake.lRPDeploymentSchedulingInfoMutex.Unlock()
	if fake.LRPDeploymentSchedulingInfoStub != nil {
		return fake.LRPDeploymentSchedulingInfoStub(arg1, arg2)
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
...
func (fake *FakeClient) LRPDeploymentSchedulingInfoCallCount() int {
...
func (fake *FakeClient) LRPDeploymentSchedulingInfoArgsForCall(i int) (lager.Logger, models.LRPDeploymentFilter) {
	fake.lRPDeploymentSchedulingInfoMutex.RLock()
	defer fake.lRPDeploymentSchedulingInfoMutex.RUnlock()
	return fake.lRPDeploymentSchedulingInfoArgsForCall[i].arg1, fake.lRPDeploymentSchedulingInfoArgsForCall[i].arg2
}

func (fake *FakeClient) LRPDeploymentSchedulingInfoReturns(result1 []*models.LRPDeploymentSchedulingInfo, result2 error) {
...
func (fake *FakeClient) LRPDeploymentSchedulingInfoReturnsOnCall(i int, result1 []*models.LRPDeploymentSchedulingInfo, result2 error) {
	fake.LRPDeploymentSchedulingInfoStub = nil
