...
var _ = FDescribe("Task Controller", func() {
	var (
	...
	// 		JustBeforeEach(func() {
	// 			err = controller.ConvergeTasks(kickTaskDuration, expirePendingTaskDuration, expireCompletedTaskDuration)
	// 		})
	...
	// 					Expect(logger.TestSink.LogMessages()).To(ContainElement("test.task-controller.converge-tasks.failed-to-request-auctions-for-pending-tasks"))
	// 				})
	// 			})
	// 		})
	// 	})
