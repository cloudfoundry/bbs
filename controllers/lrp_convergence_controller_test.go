...
var _ = Describe("LRP Convergence Controllers", func() {
	...
	BeforeEach(func() {
		...
		cellPresence := models.NewCellPresence("cell-id", "1.1.1.1", "", "z1", models.CellCapacity{}, nil, nil, nil, nil, nil, nil)
	...
	Describe("metrics", func() {
		...
		Context("when there are multiple cells", func() {
			BeforeEach(func() {
				presentCellPresence1 := models.NewCellPresence("cell-id-1", "1.1.1.1", "", "z1", models.CellCapacity{}, nil, nil, nil, nil, nil, nil)
				presentCellPresence2 := models.NewCellPresence("cell-id-2", "1.1.1.2", "", "z1", models.CellCapacity{}, nil, nil, nil, nil, nil, nil)
	...
	Context("lrps with internal routes that needs updated", func() {
		...
		BeforeEach(func() {
			...
			cell1Presence = models.NewCellPresence(actualLRPKeyWithInternalRoutes1.InstanceKey.CellId, "1.1.1.1", "rep-1.service.internal", "z1", models.CellCapacity{}, nil, nil, nil, nil, nil, nil)
			cell2Presence = models.NewCellPresence(actualLRPKeyWithInternalRoutes2.InstanceKey.CellId, "1.1.1.2", "rep-2.service.internal", "z2", models.CellCapacity{}, nil, nil, nil, nil, nil, nil)
			cell3Presence = models.NewCellPresence(actualLRPKeyWithInternalRoutes3.InstanceKey.CellId, "1.1.1.3", "rep-3.service.internal", "z3", models.CellCapacity{}, nil, nil, nil, nil, nil, nil)
	...
	Context("lrps with metric tags that need to be updated", func() {
		...
		BeforeEach(func() {
			...
			cell1Presence = models.NewCellPresence(actualLRPKeyWithMetricTags1.InstanceKey.CellId, "1.1.1.1", "rep-1.service.internal", "z1", models.CellCapacity{}, nil, nil, nil, nil, nil, nil)
			cell2Presence = models.NewCellPresence(actualLRPKeyWithMetricTags2.InstanceKey.CellId, "1.1.1.2", "rep-2.service.internal", "z2", models.CellCapacity{}, nil, nil, nil, nil, nil, nil)
			cell3Presence = models.NewCellPresence(actualLRPKeyWithMetricTags3.InstanceKey.CellId, "1.1.1.3", "rep-3.service.internal", "z3", models.CellCapacity{}, nil, nil, nil, nil, nil, nil)
			fakeServiceClient.CellByIdCalls(func(logger lager.Logger, cellId string) (*models.CellPresence, error) {
				switch cellId {
				case "cell-id-1":
					return &cell1Presence, nil
